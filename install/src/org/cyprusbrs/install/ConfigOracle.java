...
import org.cyprusbrs.db.DB_Oracle;
...
public class ConfigOracle extends Config
{
	...
	public String test()
	{
		...
		setProperty(ConfigurationData.CYPRUS_DB_SERVER, databaseServer.getHostName());
		setProperty(ConfigurationData.CYPRUS_DB_TYPE, p_data.getDatabaseType());
		setProperty(ConfigurationData.CYPRUS_DB_PATH, p_data.getDatabaseType());
		...
		setProperty(ConfigurationData.CYPRUS_DB_PORT, String.valueOf(databasePort));
		...
		setProperty(ConfigurationData.CYPRUS_DB_URL, url);
		log.info("OK: Database System User " + databaseName);
		setProperty(ConfigurationData.CYPRUS_DB_NAME, databaseName);
		setProperty(ConfigurationData.CYPRUS_DB_SYSTEM, systemPassword);
		...
		if (pass)
		{
			...
			if (m_con != null)
				setProperty(ConfigurationData.CYPRUS_WEBSTORES, getWebStores(m_con));
		}
		else
			log.warning(error);
		setProperty(ConfigurationData.CYPRUS_DB_USER, databaseUser);
		setProperty(ConfigurationData.CYPRUS_DB_PASSWORD, databasePassword);
