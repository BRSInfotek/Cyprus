...
import org.cyprusbrs.db.Database;
import org.cyprusbrs.util.CLogMgt;
import org.cyprusbrs.util.CLogger;
import org.cyprusbrs.util.EMail;
import org.cyprusbrs.util.EMailAuthenticator;
...
public class ConfigurationData
{
	...
	public static final String	CYPRUS_ENV_FILE		= "CyprusEnv.properties";
	
	/** Cyprus Home					*/
	public static final String	CYPRUS_HOME 			= "CYPRUS_HOME";
	/** 				*/
	public static final String	JAVA_HOME 				= "JAVA_HOME";
	/** 				*/
	public static final String	JAVA_TYPE 				= "CYPRUS_JAVA_TYPE";
	/** 				*/
	public static final String	CYPRUS_JAVA_OPTIONS 	= "CYPRUS_JAVA_OPTIONS";
	/** Default Keysore Password		*/
	public static final String	KEYSTORE_PASSWORD		= "cyprus";

	/** 				*/
	public static final String	CYPRUS_APPS_TYPE		= "CYPRUS_APPS_TYPE";
	/** 				*/
	public static final String	CYPRUS_APPS_SERVER 	= "CYPRUS_APPS_SERVER";
	/** 				*/
	public static final String	CYPRUS_APPS_DEPLOY	= "CYPRUS_APPS_DEPLOY";
	/** 				*/
	public static final String	CYPRUS_JNP_PORT 		= "CYPRUS_JNP_PORT";
	/** 				*/
	public static final String	CYPRUS_WEB_PORT 		= "CYPRUS_WEB_PORT";
	/** 				*/
	public static final String	CYPRUS_SSL_PORT 		= "CYPRUS_SSL_PORT";
	/** 				*/
	public static final String	CYPRUS_WEB_ALIAS 	= "CYPRUS_WEB_ALIAS";
	
	/** 				*/
	public static final String	CYPRUS_KEYSTORE 		= "CYPRUS_KEYSTORE";
	/** 				*/
	public static final String	CYPRUS_KEYSTOREPASS	= "CYPRUS_KEYSTOREPASS";
	/** 				*/
	public static final String	CYPRUS_KEYSTORECODEALIAS	= "CYPRUS_KEYSTORECODEALIAS";
	/** 				*/
	public static final String	CYPRUS_KEYSTOREWEBALIAS	= "CYPRUS_KEYSTOREWEBALIAS";
	
	public static final String	CYPRUS_CERT_CN	= "CYPRUS_CERT_CN";
	
	public static final String	CYPRUS_CERT_ORG	= "CYPRUS_CERT_ORG";
	
	public static final String	CYPRUS_CERT_ORG_UNIT	= "CYPRUS_CERT_ORG_UNIT";
	
	public static final String	CYPRUS_CERT_LOCATION	= "CYPRUS_CERT_LOCATION";
	
	public static final String	CYPRUS_CERT_STATE	= "CYPRUS_CERT_STATE";
	
	public static final String	CYPRUS_CERT_COUNTRY	= "CYPRUS_CERT_COUNTRY";

	/** DB Type			*/
	public static final String	CYPRUS_DB_TYPE		= "CYPRUS_DB_TYPE";
	/** DB Path			*/
	public static final String	CYPRUS_DB_PATH		= "CYPRUS_DB_PATH";
	/** 				*/
	/** 				*/
	public static final String	CYPRUS_DB_SERVER 	= "CYPRUS_DB_SERVER";
	/** 				*/
	public static final String	CYPRUS_DB_PORT 		= "CYPRUS_DB_PORT";
	/** 				*/
	public static final String	CYPRUS_DB_NAME 		= "CYPRUS_DB_NAME";
	/** 				*/
	public static final String	CYPRUS_DB_URL 		= "CYPRUS_DB_URL";

	/** 				*/
	public static final String	CYPRUS_DB_USER 		= "CYPRUS_DB_USER";
	/** 				*/
	public static final String	CYPRUS_DB_PASSWORD 	= "CYPRUS_DB_PASSWORD";
	/** 				*/
	public static final String	CYPRUS_DB_SYSTEM 	= "CYPRUS_DB_SYSTEM";

	/** 				*/
	public static final String	CYPRUS_MAIL_SERVER 	= "CYPRUS_MAIL_SERVER";
	/** 				*/
	public static final String	CYPRUS_MAIL_USER 	= "CYPRUS_MAIL_USER";
	/** 				*/
	public static final String	CYPRUS_MAIL_PASSWORD = "CYPRUS_MAIL_PASSWORD";
	/** 				*/
	public static final String	CYPRUS_ADMIN_EMAIL	= "CYPRUS_ADMIN_EMAIL";
	/** 				*/
	public static final String	CYPRUS_MAIL_UPDATED	= "CYPRUS_MAIL_UPDATED";

	/** 				*/
	public static final String	CYPRUS_FTP_SERVER	= "CYPRUS_FTP_SERVER";
	/** 				*/
	public static final String	CYPRUS_FTP_USER		= "CYPRUS_FTP_USER";
	/** 				*/
	public static final String	CYPRUS_FTP_PASSWORD	= "CYPRUS_FTP_PASSWORD";
	/** 				*/
	public static final String	CYPRUS_FTP_PREFIX	= "CYPRUS_FTP_PREFIX";

	/** 				*/
	public static final String	CYPRUS_WEBSTORES		= "CYPRUS_WEBSTORES";
	...
	public boolean load()
	{
		//	Load C:\Cyprus\CyprusEnv.properties
		String cyprusHome = System.getProperty(CYPRUS_HOME);
		if (cyprusHome == null || cyprusHome.length() == 0)
			cyprusHome = System.getProperty("user.dir");
		
		boolean envLoaded = false;
		String fileName = cyprusHome + File.separator + CYPRUS_ENV_FILE;
		...
		if (env.exists())
		{
			...
			//
			setCyprusHome((String)p_properties.get(CYPRUS_HOME));
			String s = (String)p_properties.get(CYPRUS_KEYSTOREPASS);
			if (s == null || s.length() == 0)
			{
				s = KEYSTORE_PASSWORD;
				p_properties.put(CYPRUS_KEYSTOREPASS, s);
			}
			setKeyStore(s);
			//
			int appServerIndex = setAppsServerType((String)p_properties.get(CYPRUS_APPS_TYPE));
			initAppsServer(appServerIndex);
			if (loaded.containsKey(CYPRUS_APPS_SERVER))
				setAppsServer((String)loaded.get(CYPRUS_APPS_SERVER));
			if (loaded.containsKey(CYPRUS_APPS_DEPLOY))
				setAppsServerDeployDir((String)loaded.get(CYPRUS_APPS_DEPLOY));
			if (loaded.containsKey(CYPRUS_JNP_PORT))
				setAppsServerJNPPort((String)loaded.get(CYPRUS_JNP_PORT));
			if (loaded.containsKey(CYPRUS_WEB_PORT))
				setAppsServerWebPort((String)loaded.get(CYPRUS_WEB_PORT));
			if (loaded.containsKey(CYPRUS_SSL_PORT))
				setAppsServerSSLPort((String)loaded.get(CYPRUS_SSL_PORT));
			//
			int dbTypeIndex = setDatabaseType((String)p_properties.get(CYPRUS_DB_TYPE));
			initDatabase((String)p_properties.get(CYPRUS_DB_NAME), dbTypeIndex);	//	fills Database Options
			if (loaded.containsKey(CYPRUS_DB_NAME))
				setDatabaseDiscovered((String)loaded.get(CYPRUS_DB_NAME));
			if (loaded.containsKey(CYPRUS_DB_SERVER))
				setDatabaseServer((String)loaded.get(CYPRUS_DB_SERVER));
			if (loaded.containsKey(CYPRUS_DB_PORT))
				setDatabasePort((String)loaded.get(CYPRUS_DB_PORT));
			if (loaded.containsKey(CYPRUS_DB_NAME))
				setDatabaseName((String)loaded.get(CYPRUS_DB_NAME));
			if (loaded.containsKey(CYPRUS_DB_USER))
				setDatabaseUser((String)loaded.get(CYPRUS_DB_USER));
			if (loaded.containsKey(CYPRUS_DB_PASSWORD))
				setDatabasePassword((String)loaded.get(CYPRUS_DB_PASSWORD));
			if (loaded.containsKey(CYPRUS_DB_SYSTEM))
				setDatabaseSystemPassword((String)loaded.get(CYPRUS_DB_SYSTEM));

			if (p_panel != null)
			{
				p_panel.fMailServer.setText((String)p_properties.get(CYPRUS_MAIL_SERVER));
				p_panel.fMailUser.setText((String)p_properties.get(CYPRUS_MAIL_USER));
				p_panel.fMailPassword.setText((String)p_properties.get(CYPRUS_MAIL_PASSWORD));
				p_panel.fAdminEMail.setText((String)p_properties.get(CYPRUS_ADMIN_EMAIL));
			}
		}
	...
	//	envLoaded = false;
		if (!envLoaded)
		{
			...
			setDatabaseSystemPassword("System"); /// default password for DB
			setDatabaseServer(hostName);
			setDatabaseUser("cyprus"); // default username of cyprus
			setDatabasePassword("cyprus"); // default password of cyprus
			//	Mail Server
			if (p_panel != null)
			{
		...
		//	Default FTP stuff
		if (!p_properties.containsKey(CYPRUS_FTP_SERVER))
		{
			p_properties.setProperty(CYPRUS_FTP_SERVER, "localhost");
			p_properties.setProperty(CYPRUS_FTP_USER, "anonymous");
			p_properties.setProperty(CYPRUS_FTP_PASSWORD, "user@host.com");
			p_properties.setProperty(CYPRUS_FTP_PREFIX, "my");
		}
		//	Default Java Options
		if (!p_properties.containsKey(CYPRUS_JAVA_OPTIONS))
			p_properties.setProperty(CYPRUS_JAVA_OPTIONS, "-Xms64M -Xmx512M");
		//	Web Alias
		if (!p_properties.containsKey(CYPRUS_WEB_ALIAS) && localhost != null)
			p_properties.setProperty(CYPRUS_WEB_ALIAS, localhost.getCanonicalHostName());
		
		//	(String)p_properties.get(CYPRUS_DB_URL)	//	derived
		
		//	Keystore Alias
		if (!p_properties.containsKey(CYPRUS_KEYSTORECODEALIAS))
			p_properties.setProperty(CYPRUS_KEYSTORECODEALIAS, "cyprus");
		if (!p_properties.containsKey(CYPRUS_KEYSTOREWEBALIAS))
			p_properties.setProperty(CYPRUS_KEYSTOREWEBALIAS, "cyprus");
	...
	/**
	 * 	Test Cyprus and set CyprusHome
	 *	@return error message or null if OK
	 */
	private String testCyprus()
	{
		//	Cyprus Home
		m_cyprusHome = new File (getCyprusHome());
		boolean pass =m_cyprusHome.exists();
		String error = "Not found: CyprusHome = " + m_cyprusHome;
		if (p_panel != null)
			p_panel.signalOK(p_panel.okCyprusHome, "ErrorCyprusHome", 
					pass, true, error);
		if (!pass)
			return error;
		log.info("OK: CyprusHome = " + m_cyprusHome);
		p_properties.setProperty(CYPRUS_HOME, m_cyprusHome.getAbsolutePath());
		System.setProperty(CYPRUS_HOME, m_cyprusHome.getAbsolutePath());
		
		//	KeyStore
		String fileName = KeyStoreMgt.getKeystoreFileName(m_cyprusHome.getAbsolutePath());
		p_properties.setProperty(CYPRUS_KEYSTORE, fileName);
		
		//	KeyStore Password
		String pw = p_panel != null 
			? new String(p_panel.fKeyStore.getPassword())
			: (String)p_properties.get(CYPRUS_KEYSTOREPASS);
		...
		if (!pass)
			return error;
		p_properties.setProperty(CYPRUS_KEYSTOREPASS, pw);
		KeyStoreMgt ks = p_panel != null
			? new KeyStoreMgt (fileName, p_panel.fKeyStore.getPassword())
			: new KeyStoreMgt (fileName, pw.toCharArray());
		ks.setCommonName((String)p_properties.getProperty(CYPRUS_CERT_CN));
		ks.setOrganization((String)p_properties.getProperty(CYPRUS_CERT_ORG));
		ks.setOrganizationUnit((String)p_properties.getProperty(CYPRUS_CERT_ORG_UNIT));
		ks.setLocation((String)p_properties.getProperty(CYPRUS_CERT_LOCATION));
		ks.setState((String)p_properties.getProperty(CYPRUS_CERT_STATE));
		ks.setCountry((String)p_properties.getProperty(CYPRUS_CERT_COUNTRY));
		error = p_panel != null 
	...
	private String testMail()
	{
		...
		String server = p_panel != null
			...
			: (String)p_properties.get(CYPRUS_MAIL_SERVER);
		...
		if (!pass)
		{
			p_properties.setProperty(CYPRUS_MAIL_SERVER, "");
			return error;
		}
		p_properties.setProperty(CYPRUS_MAIL_SERVER, mailServer.getHostName());

		//	Mail User
		String mailUser = p_panel != null 
			? p_panel.fMailUser.getText()
			: (String)p_properties.get(CYPRUS_MAIL_USER);
		String mailPassword = p_panel != null
			? new String(p_panel.fMailPassword.getPassword())
			: (String)p_properties.get(CYPRUS_MAIL_PASSWORD);
	...
	//	log.config("Mail User = " + mailUser + "/" + mailPassword);
		...
		String adminEMailString = p_panel != null 
			...
			: (String)p_properties.get(CYPRUS_ADMIN_EMAIL);
		...
		if (pass)
		{
			...
			p_properties.setProperty(CYPRUS_ADMIN_EMAIL, adminEMail.toString());
			p_properties.setProperty(CYPRUS_MAIL_USER, mailUser);
			p_properties.setProperty(CYPRUS_MAIL_PASSWORD, mailPassword);
			p_properties.setProperty(CYPRUS_MAIL_UPDATED, "No");
		}
		else
		{
			log.warning(error);
			p_properties.setProperty(CYPRUS_ADMIN_EMAIL, "");
			p_properties.setProperty(CYPRUS_MAIL_USER, "");
			p_properties.setProperty(CYPRUS_MAIL_PASSWORD, "");
			p_properties.setProperty(CYPRUS_MAIL_UPDATED, "");
		}
		return null;
	}	//	testMail
	...
	{
		//	Add
		p_properties.setProperty("CYPRUS_MAIN_VERSION", Cyprus.MAIN_VERSION);
		p_properties.setProperty("CYPRUS_DATE_VERSION", Cyprus.DATE_VERSION);
		p_properties.setProperty("CYPRUS_DB_VERSION", Cyprus.DB_VERSION);

		log.finest(p_properties.toString());
		
		//	Before we save, load Ini
		Ini.setClient(false);
		String fileName = m_cyprusHome.getAbsolutePath() + File.separator + Ini.CYPRUS_PROPERTY_FILE;
		Ini.loadProperties(fileName);

		//	Save Environment
		fileName = m_cyprusHome.getAbsolutePath() + File.separator + CYPRUS_ENV_FILE;
		try
		{
			FileOutputStream fos = new FileOutputStream(new File(fileName));
			p_properties.store(fos, CYPRUS_ENV_FILE);
			fos.flush();
			fos.close();
		}
		catch (Exception e)
		{
			...
			if (p_panel != null)
				JOptionPane.showConfirmDialog(p_panel, 
					...
					ConfigurationPanel.res.getString("CyprusServerSetup"),
	...
	{
		Ini.setCyprusHome(m_cyprusHome.getAbsolutePath());
	 ...
	 *	@return cyprus home
	 */
	public String getCyprusHome()
	{
		return p_panel != null 
			? p_panel.fCyprusHome.getText()
			: (String)p_properties.get(CYPRUS_HOME);
	}	//	getCyprusHome
	 ...
	 *	@param cyprusHome
	 */
	public void setCyprusHome (String cyprusHome)
	{
		if (p_panel != null)
			p_panel.fCyprusHome.setText(cyprusHome);
		else
			updateProperty(CYPRUS_HOME, cyprusHome);
	}	//	setCyprusHome
	...
	public void setKeyStore (String password)
	{
		if (p_panel != null)
			...
			updateProperty(CYPRUS_KEYSTOREPASS, password);
	}	//	setKeyStore
	...
	public String testAppsServer()
	{
		int index = p_panel != null 
			...
			: setAppsServerType((String)p_properties.get(CYPRUS_APPS_TYPE));
		if (index < 0 || index >= APPSTYPE.length)
	...
	public int setAppsServerType (String appsType)
	{
		...
		if (p_panel != null)
			...
			updateProperty(CYPRUS_APPS_TYPE, appsType);
	...
	public String getAppsServerType ()
	{
		return p_panel != null
			...
			: (String)p_properties.get(CYPRUS_APPS_TYPE);
	}	//	setDatabaseType
	...
	public String getAppsServer ()
	{
		return p_panel != null 
			...
			: (String)p_properties.get(CYPRUS_APPS_SERVER);
	}
	/**
	...
	public void setAppsServer (String appsServer)
	{
		if (p_panel != null)
			...
			updateProperty(CYPRUS_APPS_SERVER, appsServer);
	}
	...
	public String getAppsServerDeployDir ()
	{
		return p_panel != null
			...
			: (String)p_properties.get(CYPRUS_APPS_DEPLOY);
	}
	/**
	...
	public void setAppsServerDeployDir (String appsServerDeployDir)
	{
		if (p_panel != null)
			...
			updateProperty(CYPRUS_APPS_DEPLOY, appsServerDeployDir);
	}
	/**
	...
	public int getAppsServerJNPPort ()
	{
		String port = p_panel != null
			...
			: (String)p_properties.get(CYPRUS_JNP_PORT);
		try
		{
	...
	public void setAppsServerJNPPort (String appsServerJNPPort)
	{
		if (p_panel != null)
			...
			updateProperty(CYPRUS_JNP_PORT, appsServerJNPPort);
	}
	...
	public int getAppsServerSSLPort ()
	{
		String port = p_panel != null
			...
			: (String)p_properties.get(CYPRUS_SSL_PORT);
		try
		{
			return Integer.parseInt(port);
		}
	...
	public void setAppsServerSSLPort (String appsServerSSLPort)
	{
		if (p_panel != null)
			...
			updateProperty(CYPRUS_SSL_PORT, appsServerSSLPort);
	}
	/**
	...
	public int getAppsServerWebPort ()
	{
		String port = p_panel != null
			...
			: (String)p_properties.get(CYPRUS_WEB_PORT);
		try
		{
			return Integer.parseInt(port);
		}
	...
	public void setAppsServerWebPort (String appsServerWebPort)
	{
		if (p_panel != null)
			...
			updateProperty(CYPRUS_WEB_PORT, appsServerWebPort);
	}
	/**
	...
	public String testDatabase()
	{
		int index = p_panel != null 
			...
			: setDatabaseType((String)p_properties.get(CYPRUS_DB_TYPE));
		if (index < 0 || index >= DBTYPE.length)
	...
	public int setDatabaseType (String databaseType)
	{
		...
		if (p_panel != null)
			...
			updateProperty(CYPRUS_DB_TYPE, databaseType);
	...
	public String getDatabaseType ()
	{
		return p_panel != null
			...
			: (String)p_properties.get(CYPRUS_DB_TYPE);
	}
	/**
	...
	public String getDatabaseName ()
	{
		return p_panel != null
			...
			: (String)p_properties.get(CYPRUS_DB_NAME);
	}
	/**
	...
	public void setDatabaseName (String databaseName)
	{
		if (p_panel != null)
			...
			updateProperty(CYPRUS_DB_NAME, databaseName);
	}
	...
	public String getDatabasePassword ()
	{
		...
		{
			String pw = (String)p_properties.get(CYPRUS_DB_PASSWORD);
			return (pw != null ? pw : "");
		}
	}
	/**
	...
	public void setDatabasePassword (String databasePassword)
	{
		if (p_panel != null)
			...
			updateProperty(CYPRUS_DB_PASSWORD, databasePassword);
	}
	/**
	...
	public int getDatabasePort ()
	{
		String port = p_panel != null
			...
			: (String)p_properties.get(CYPRUS_DB_PORT);
		try
		{
			return Integer.parseInt(port);
		}
	...
	public void setDatabasePort (String databasePort)
	{
		if (p_panel != null)
			...
			updateProperty(CYPRUS_DB_PORT, databasePort);
	}
	/**
	...
	public String getDatabaseServer ()
	{
		return p_panel != null
			...
			: (String)p_properties.get(CYPRUS_DB_SERVER);
	}
	/**
	...
	public void setDatabaseServer (String databaseServer)
	{
		if (p_panel != null)
			...
			updateProperty(CYPRUS_DB_SERVER, databaseServer);
	}
	/**
	...
	public String getDatabaseSystemPassword ()
	{
		...
		{
			String pw = (String)p_properties.get(CYPRUS_DB_SYSTEM);
			return (pw != null ? pw : "");
		}
	}
	/**
	...
	public void setDatabaseSystemPassword (String databaseSystemPassword)
	{
		if (p_panel != null)
			...
			updateProperty(CYPRUS_DB_SYSTEM, databaseSystemPassword);
	}
	/**
	...
	public String getDatabaseUser ()
	{
		return p_panel != null
			...
			: (String)p_properties.get(CYPRUS_DB_USER);
	}
	/**
	...
	public void setDatabaseUser (String databaseUser)
	{
		if (p_panel != null)
			...
			updateProperty(CYPRUS_DB_USER, databaseUser);
	}
