...
import org.cyprusbrs.swing.CCheckBox;
import org.cyprusbrs.swing.CComboBox;
import org.cyprusbrs.swing.CLabel;
import org.cyprusbrs.swing.CPanel;
import org.cyprusbrs.swing.CPassword;
import org.cyprusbrs.swing.CTextField;
...
public class ConfigurationPanel extends CPanel implements ActionListener
{
	...
	/** Translation				*/
	static ResourceBundle 		res = ResourceBundle.getBundle("org.cyprusbrs.install.SetupRes");
	...
	private static ImageIcon iSave = new ImageIcon(Cyprus.class.getResource("images/Save16.gif"));
	private static ImageIcon iHelp = new ImageIcon(Cyprus.class.getResource("images/Help16.gif"));
	...
	//	Cyprus - KeyStore
	private CLabel 		lCyprusHome = new CLabel();
	CTextField 	fCyprusHome = new CTextField(FIELDLENGTH);
	CCheckBox 	okCyprusHome = new CCheckBox();
	private CButton 	bCyprusHome = new CButton(iOpen);
	...
	private void jbInit() throws Exception
	{
		...
		//	CyprusHome - KeyStore
		lCyprusHome.setToolTipText(res.getString("CyprusHomeInfo"));
		lCyprusHome.setText(res.getString("CyprusHome"));
		fCyprusHome.setText(".");
		okCyprusHome.setEnabled(false);
		bCyprusHome.setMargin(bInsets);
		bCyprusHome.setToolTipText(res.getString("CyprusHomeInfo"));
		...
		sectionLabel = new JLabel("Cyprus");
		sectionLabel.setForeground(titledBorder.getTitleColor());
		...
		this.add(separator,    new GridBagConstraints(0, 4, 7, 1, 1.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 5, 0, 10), 0, 0));
		this.add(lCyprusHome,		new GridBagConstraints(0, 5, 1, 1, 0.0, 0.0
			,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 2, 5), 0, 0));
		this.add(fCyprusHome,		new GridBagConstraints(1, 5, 1, 1, 0.5, 0.0
			,GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(5, 5, 2, 0), 0, 0));
		this.add(okCyprusHome,	new GridBagConstraints(2, 5, 1, 1, 0.0, 0.0
			,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 0, 2, 5), 0, 0));
		this.add(bCyprusHome,     new GridBagConstraints(3, 5, 1, 1, 0.0, 0.0
			,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		...
		//
		bCyprusHome.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		//
			...
			setPath (fJavaHome);
		else if (e.getSource() == bCyprusHome)
			setPath (fCyprusHome);
	 ...
	 *  @return SwingWorker
	 */
	private org.cyprusbrs.apps.SwingWorker startTest(final boolean saveIt)
	{
		org.cyprusbrs.apps.SwingWorker worker = new org.cyprusbrs.apps.SwingWorker()
		{
			//	Start it
	...
	private void save()
	{
		...
		JOptionPane.showConfirmDialog(this, res.getString("EnvironmentSaved"),
			res.getString("CyprusServerSetup"),
