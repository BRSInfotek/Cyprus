...
import org.cyprusbrs.apps.OnlineHelp;
...
//		}
	...
	private void jbInit() throws Exception
	{
		...
		this.setTitle(res.getString("CyprusServerSetup") + " " + res.getString("Help"));
	...
	private void dynInit()
	{
		try
		{
			editorPane.setPage("https://cypruserp.com/contact");
		}
		catch (IOException ex)
		{
			editorPane.setText(res.getString("PleaseCheck")
				+ "	https://cypruserp.com/contact <p>("
