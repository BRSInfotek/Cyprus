...
public class ConfigJBoss extends Config
{
	...
	{
		return p_data.getCyprusHome()
			+ File.separator + "jboss"
			+ File.separator + "server"
			+ File.separator + "cyprus"  // updated by Mukesh @20210325
	...
	public String test()
	{
		...
		setProperty(ConfigurationData.CYPRUS_APPS_SERVER, appsServer.getHostName());
		setProperty(ConfigurationData.CYPRUS_APPS_TYPE, p_data.getAppsServerType());
		...
		if (!pass)
			return error;
		setProperty(ConfigurationData.CYPRUS_APPS_DEPLOY, p_data.getAppsServerDeployDir());
		...
		setProperty(ConfigurationData.CYPRUS_JNP_PORT, String.valueOf(JNPPort));
		...
		setProperty(ConfigurationData.CYPRUS_WEB_PORT, String.valueOf(WebPort));
		...
		setProperty(ConfigurationData.CYPRUS_SSL_PORT, String.valueOf(sslPort));
		//
		return null;
	}	//	test
