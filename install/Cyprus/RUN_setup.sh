...
# $JAVA -classpath $CP -DADEMPIERE_HOME=$ADEMPIERE_HOME -DTestOCI=Y org.cyprusbrs.install.Setup $ARGS

$JAVA -classpath $CP -DADEMPIERE_HOME=$ADEMPIERE_HOME org.cyprusbrs.install.Setup $ARGS
...
#echo ================================
#%JAVA% -classpath lib/Adempiere.jar:lib/AdempiereCLib.jar org.cyprusbrs.install.ConnectTest localhost
