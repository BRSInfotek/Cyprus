...
import org.cyprus.webui.event.DrillEvent;
import org.cyprus.webui.event.ZoomEvent;
import org.cyprus.webui.panel.StatusBarPanel;
import org.cyprus.webui.report.HTMLExtension;
...
public class ZkReportViewer extends Window implements EventListener {
	...
	private void init() {
		...
		try {
			...
			throw new CyprusException("Failed to render report", e);
		}
