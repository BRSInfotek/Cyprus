 ...
 *****************************************************************************/
package org.cyprus.webui.process;
...
public class WProcessInfo extends ProcessInfo {
	...
	private String dynamicTranslate(String className) {
		...
		String zkPackage = "org.cyprus.webui.";
		String zkPrefix = "W";
		
		//first, try replace package
		if (className.startsWith("org.cyprusbrs."))
		{
			tail = className.substring("org.cyprusbrs.".length());
		}
		else if(className.startsWith("org.cyprus."))
		{
			tail = className.substring("org.cyprus.".length());
		}
		if (tail != null)
		{
