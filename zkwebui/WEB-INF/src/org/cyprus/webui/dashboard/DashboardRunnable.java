...
import org.cyprus.webui.CyprusWebUI;
import org.cyprus.webui.desktop.IDesktop;
import org.cyprus.webui.session.ServerContext;
...
public class DashboardRunnable implements Runnable, Serializable
{
	...
	private void killSession() {
		if (desktop.getSession() != null && desktop.getSession().getNativeSession() != null)
		{
			...
			try
			{
				Object sessionObj = desktop.getSession().getAttribute(CyprusWebUI.ZK_DESKTOP_SESSION_KEY);
