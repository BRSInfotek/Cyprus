...
package org.cyprus.webui.component;
...
{	
		...
		try
		{
			while (rs.next())
			{
				...
				for (col = 0; col < m_layout.length; col++)
				{
					...
					{
						throw new CyprusException("Cannot enter a " + columnClass.getName()
								+ " in column " + col + ". " +
	...
	/* (non-Javadoc)
	 * @see org.cyprus.webui.event.TableValueChangeListener#tableValueChange
	 * 		(org.cyprus.webui.event.TableValueChangeEvent)
	 */
