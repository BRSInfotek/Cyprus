...
import org.cyprus.webui.component.DrillCommand;
import org.cyprus.webui.component.TokenCommand;
import org.cyprus.webui.component.ZoomCommand;
import org.cyprus.webui.desktop.DefaultDesktop;
import org.cyprus.webui.desktop.IDesktop;
import org.cyprus.webui.event.TokenEvent;
import org.cyprus.webui.session.SessionContextListener;
import org.cyprus.webui.session.SessionManager;
import org.cyprus.webui.theme.ThemeManager;
import org.cyprus.webui.util.BrowserToken;
 ...
 * @author hengsin
 */
public class CyprusWebUI extends Window implements EventListener, IWebClient
{    
	/**
	 * 
	 */
	...
	public static final String APP_NAME = "Cyprus"; /// Updated by Mukesh @20201013
	...
	private static final CLogger logger = CLogger.getCLogger(CyprusWebUI.class);
