 ...
 *****************************************************************************/
package org.cyprus.webui.theme;
...
public final class ThemeManager {
	...
	public static String getBrowserTitle() {
		return MSysConfig.getValue("ZK_BROWSER_TITLE", CyprusWebUI.APP_NAME);
	}
	...
	public static String getLoginLeftPanel() {
		String theme = getTheme();
		return ITheme.THEME_PATH_PREFIX + theme + ITheme.LOGIN_RIGHT_PANEL_ZUL;
//		return ITheme.THEME_PATH_PREFIX + theme + ITheme.LOGIN_LEFT_PANEL_ZUL; /// Commented by Mukesh to removed Left Panel in Login Page completely @20210226
	}
