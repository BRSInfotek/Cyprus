...
import org.cyprus.webui.theme.ITheme;
...
import org.cyprus.webui.window.LoginWindow;
...
{	
	...
	private static final String RESOURCE = "org.cyprusbrs.apps.ALoginRes";
...
//        txtPassword.setMaxlength(40);
    ...
    **/
	...
	private String getUpdateTimeoutTextScript() {
		...
		String s = "cyprus.store.set(\"zkTimeoutText\", \"" + msg + "\")";
		return s;
	}
