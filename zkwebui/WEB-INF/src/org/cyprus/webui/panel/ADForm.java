...
import org.cyprus.webui.util.ADClassNameMap;
import org.cyprusbrs.model.MForm;
...
public abstract class ADForm extends Window implements EventListener
{
	...
	private static String translateFormClassName(String originalName)
	{
		 ...
		 */
		final String zkPackage = "org.cyprus.webui.";
		/*
		...
		if (originalName.startsWith("org.cyprusbrs."))
		{
			tail = originalName.substring("org.cyprusbrs.".length());
		}
		else if(originalName.startsWith("org.cyprus."))
		{
			tail = originalName.substring("org.cyprus.".length());
		}
		if (tail != null)
		{
	...
	public static ADForm openForm (int adFormID)
	{
    	...
    	{
			throw new CyprusException("There is no form associated with the specified selection");
    	}
    	else
    	{
    		...
    		{
    			throw new CyprusException("Web UI form not implemented for the swing form " +
 					   richClassName);
    		}
    		...
    		{
    			throw new CyprusException("The selected web user interface custom form '" +
    					   webClassName +
    					   "' is not accessible.", e);
    		}
        	...
        	try
        	{
        		...
        		else if (obj instanceof IFormController)
        		{
        			...
        			if(o instanceof ADForm)
        			{
	        			...
	        			throw new CyprusException("The web user interface custom form '" +
	    						webClassName +
