...
import org.cyprus.pos.services.ScanBar;
...
public class WScanBarUI extends ScanBar implements IFormController, EventListener ,ValueChangeListener
{
    ...
    //  load Locator
    	...
    	locatorField.addValueChangeListener((org.cyprus.webui.event.ValueChangeListener) this);
    	...
    	//locatorField.setMandatory(true);
    	locatorToField.addValueChangeListener((org.cyprus.webui.event.ValueChangeListener) this);
