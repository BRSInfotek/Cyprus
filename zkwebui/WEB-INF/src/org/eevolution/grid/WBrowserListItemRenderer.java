...
import org.cyprus.pos.util.ValueChangeEvent;
import org.cyprus.pos.util.ValueChangeListener;
import org.cyprus.pos.grid.BrowserRow;
...
import org.cyprus.webui.component.ListCell;
...
import org.cyprus.webui.component.NumberBox;
import org.cyprus.webui.component.Textbox;
import org.cyprus.webui.component.WTableColumn;
import org.cyprus.webui.component.ZkCssHelper;
import org.cyprus.webui.editor.WEditor;
import org.cyprus.webui.editor.WebEditorFactory;
import org.cyprus.webui.event.TableValueChangeEvent;
import org.cyprus.webui.event.TableValueChangeListener;
import org.cyprusbrs.minigrid.IDColumn;
import org.cyprusbrs.model.GridField;
import org.cyprusbrs.util.DisplayType;
import org.cyprusbrs.util.Env;
import org.cyprusbrs.util.MSort;
		...
		if (isColumnVisible && gridField != null) {
			...
			else if ((DisplayType.isNumeric(browseField.getAD_Reference_ID())) && !browseField.isKey())
			{
				...
				if (isCellEditable) {
					...
					editor.addValueChangeListener((org.cyprus.webui.event.ValueChangeListener) this);
            ...
            else if (field instanceof org.cyprus.webui.component.Combobox)
            {
            ...
            else if (field instanceof org.cyprus.webui.component.Button)
            {
                listcell.setValue(field);
                if (isCellEditable)
                {
