...
import org.cyprus.pos.model.MViewColumn;
...
public class WBrowserTable extends Listbox implements IBrowserTable, TableValueChangeListener, WTableModelListener {	
	...
	private void initialiseHeader()
	{
	    ...
	    {
	    	throw new CyprusException("Rendering of the ListHead is unsupported for "
	...
	public String prepareTable(List<MBrowseField> fields, boolean multiSelection) {
		browserRows = new BrowserRow((IBrowserTable) this);
		...
		for (MBrowseField field : fields) {
			org.cyprus.pos.model.MViewColumn columnView = field.getAD_View_Column();
			//  create sql
