...
import org.cyprusbrs.grid.ed.VLine;
...
public final class VPanel extends CTabbedPane
{
	...
	private CPanel m_main = new CPanel(org.cyprusbrs.plaf.CompiereColor.getDefaultBackground());		
	...
	private boolean addGroup(String fieldGroup, String fieldGroupType)
	{
		...
		if (fieldGroupType.equals(X_AD_FieldGroup.FIELDGROUPTYPE_Tab))
		{
			...
			m_tab.setBackground(CyprusPLAF.getFormBackground());
		...
		{				  
			...
			m_tab.getContentPane().setBackground(CyprusPLAF.getFormBackground());
		...
		else // Label or null
		{
			...
			label.setFont(CyprusPLAF.getFont_Label().deriveFont(Font.BOLDITALIC, CyprusPLAF.getFont_Label().getSize2D()));
