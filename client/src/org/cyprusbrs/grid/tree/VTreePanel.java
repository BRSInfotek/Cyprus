 ...
 *****************************************************************************/
package org.cyprusbrs.grid.tree;
...
import org.cyprusbrs.swing.ShadowBorder;
...
import de.schaeffer.cyprusbrs.tools.DocumentSearch;
...
/******************************************************************************
	...
	public VTreePanel(int WindowNo, boolean hasBar, boolean editable)
	{
		...
		if (!hasBar)
		{
			...
			//Begin - [FR 1953769]
			bar.setBackground(CyprusPLAF.getFormBackground());
			//End - [FR 1953769]
	...
	public boolean initTree (int AD_Tree_ID)
	{
		...
		if (m_hasBar)
		{
			...
			for (JToolBar jt2 : toolbar) {
				...
				//Begin - [FR 1953769]
				barPart.setUI(new CyprusTaskPaneUI());
				barPart.getContentPane().setBackground(CyprusPLAF.getFormBackground());
				//End - [FR 1953769]
	...
	private void jbInit()
	{
		...
		treeSearch.setBackground(CyprusPLAF.getInfoBackground());
