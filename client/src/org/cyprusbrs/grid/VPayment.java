	...
	implements ActionListener
{
	...
	private boolean checkMandatory()
	{
			...
			|| PaymentRule.equals(X_C_Order.PAYMENTRULE_DirectDebit))
		{
			...
			{
				tAccountCombo.setBackground(CyprusPLAF.getFieldBackground_Error());
		...
		//	sCurrencyCombo.getSelectedItem();
			...
			if (error.length() != 0)
			{
				sRoutingField.setBackground(CyprusPLAF.getFieldBackground_Error());
			...
			if (error.length() != 0)
			{
				sNumberField.setBackground(CyprusPLAF.getFieldBackground_Error());
				ADialog.error(m_WindowNo, this, error);
				dataOK = false;
			}
			...
			if (error.length() != 0)
			{
				sCheckField.setBackground(CyprusPLAF.getFieldBackground_Error());
				ADialog.error(m_WindowNo, this, error);
				dataOK = false;
			}
		}
