...
import org.cyprusbrs.model.Obscure;
	...
	implements VEditor, ActionListener, FocusListener
{
	...
	public static final int MAXDISPLAY_LENGTH = org.cyprusbrs.model.GridField.MAXDISPLAY_LENGTH;
		...
		int displayLength, int fieldLength, String VFormat, String ObscureType)
	{
		...
		setForeground(CyprusPLAF.getTextColor_Normal());
	...
	public void setText (String text)
	{
		...
		else
		{
			if (m_stdFont != null)
			{
				...
				super.setForeground(CyprusPLAF.getTextColor_Normal());
			}
			super.setText (text);
		}
	}	//	setText
