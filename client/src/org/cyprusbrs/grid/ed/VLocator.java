...
import org.cyprusbrs.apps.FieldRecordInfo;
	...
	implements VEditor, ActionListener
{
		...
		MLocatorLookup mLocator, int WindowNo)
	{
		...
		m_text.setFont(CyprusPLAF.getFont_Field());
		m_text.setForeground(CyprusPLAF.getTextColor_Normal());
		m_text.addActionListener(this);
		this.add(m_text, BorderLayout.CENTER);

		m_button.setIcon(new ImageIcon(org.cyprusbrs.Cyprus.class.getResource("images/Locator10.gif")));
	...
	{
		if (error)
			setBackground(CyprusPLAF.getFieldBackground_Error());
		else if (!isReadWrite())
			setBackground(CyprusPLAF.getFieldBackground_Inactive());
		else if (isMandatory())
			setBackground(CyprusPLAF.getFieldBackground_Mandatory());
		else
			setBackground(CyprusPLAF.getFieldBackground_Normal());
	}   //  setBackground
	 ...
	 */
	public void setField (org.cyprusbrs.model.GridField mField)
	{
		m_mField = mField;
		if (m_mField != null)
