	...
	implements ChangeListener, ActionListener, KeyListener
{
	...
	public Editor(Frame frame, String header, String text, boolean editable, int maxSize)
	{
		...
		if (editable)
			textArea.setBackground(CyprusPLAF.getFieldBackground_Normal());
		else
			textArea.setBackground(CyprusPLAF.getFieldBackground_Inactive());
		textPane.setBackground(CyprusPLAF.getFieldBackground_Inactive());
		updateStatusBar();
	}	//	Editor
