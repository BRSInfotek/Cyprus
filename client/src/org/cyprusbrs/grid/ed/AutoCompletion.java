...
public class AutoCompletion extends PlainDocument {
	...
	protected boolean startsWithIgnoreCase(String str1, String str2) {
		String s1 = org.cyprusbrs.util.Util.stripDiacritics(str1.toUpperCase()).replaceAll("^\\s+", "");;
		String s2 = org.cyprusbrs.util.Util.stripDiacritics(str2.toUpperCase()).replaceAll("^\\s+", "");;
