	...
	implements VEditor, ActionListener, KeyListener, FocusListener
{
	...
	{
		if (error)
			m_text.setBackground(CyprusPLAF.getFieldBackground_Error());
		else if (!m_readWrite)
			m_text.setBackground(CyprusPLAF.getFieldBackground_Inactive());
		else if (m_mandatory)
			m_text.setBackground(CyprusPLAF.getFieldBackground_Mandatory());
		else
			m_text.setBackground(CyprusPLAF.getFieldBackground_Normal());
	}	//	setBackground
