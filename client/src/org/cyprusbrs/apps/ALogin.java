	...
	implements ActionListener, ChangeListener
{
	...
	public ALogin (Frame parent)
	{
		...
		parent.setIconImage(Cyprus.getImage16());
	}   //  ALogin


	protected static final String RESOURCE = "org.cyprusbrs.apps.ALoginRes";
...
//	private BorderLayout defaultLayout = new BorderLayout();
	...
	private void jbInit() throws Exception
	{
		...
		titleLabel.setToolTipText(Cyprus.getURL());
		titleLabel.setHorizontalTextPosition(SwingConstants.CENTER);
		titleLabel.setIcon(Cyprus.getImageIconLogo());
		titleLabel.setText(Cyprus.getSubtitle());
		...
		compileDate.setText(Cyprus.DATE_VERSION);
		compileDate.setToolTipText(Cyprus.getImplementationVendor());
		...
		versionLabel.setText(Cyprus.MAIN_VERSION);
		versionLabel.setToolTipText(Cyprus.getImplementationVersion());
		...
		copy1Label.setText(Cyprus.COPYRIGHT);
...
*/
	...
	{
		m_cc = CConnection.get(Cyprus.getCodeBaseHost());
	...
	private boolean tryConnection()
	{
		...
		if (!DB.isConnected(false))
		{
			...
			hostField.setBackground(CyprusPLAF.getFieldBackground_Error());
			return false;
		}
		...
		try 
		{
			...
			if (roles == null || roles.length == 0)
			{
				...
				userTextField.setBackground(CyprusPLAF.getFieldBackground_Error());
				passwordField.setBackground(CyprusPLAF.getFieldBackground_Error());
				return false;
			}
		}
		catch (Throwable e)
		...
		userTextField.setBackground(CyprusPLAF.getFieldBackground_Normal());
		passwordField.setBackground(CyprusPLAF.getFieldBackground_Normal());
		//
	...
	private boolean checkVersion()
	{
		...
		try
		{
			...
			if (Cyprus.DATE_VERSION.equals(version))
			{
			...
			else if (version != null)
			{
				...
				msg.append(version == null ? "null" : version).append(" <> ")
					.append(Cyprus.DATE_VERSION).append("\n");
				msg.append(res.getString("PleaseUpgrade")).append("\n<<");
				JOptionPane.showMessageDialog(null, msg.toString(),
					Cyprus.getName() + " - " + res.getString("VersionConflict"),
