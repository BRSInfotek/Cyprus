...
import org.cyprus.apps.graph.PAPanel;
import org.cyprus.plaf.CyprusPLAF;
import org.cyprusbrs.Cyprus;
import org.cyprusbrs.apps.wf.WFActivity;
import org.cyprusbrs.apps.wf.WFPanel;
	...
	implements ActionListener, PropertyChangeListener, ChangeListener
{
	...
	{
		super();
		log.info("CodeBase=" + Cyprus.getCodeBase());		
...
//	private DecimalFormat	m_memoryFormat = DisplayType.getNumberFormat(DisplayType.Integer);
	...
	{
		//  Default Image
		this.setIconImage(Cyprus.getImage16());
