...
public class StatusBar extends CPanel implements IStatusBar
{
	...
	private void jbInit() throws Exception
	{
		...
		infoLine.setFont(CyprusPLAF.getFont_Label());
		infoLine.setBorder(BorderFactory.createLineBorder(CyprusPLAF.getSecondary2()));
	...
	public void setStatusLine (String text, boolean error)
	{
		...
		mt_text = text;
		if (mt_error)
			statusLine.setForeground(CyprusPLAF.getTextColor_Issue());
		else
			statusLine.setForeground(CyprusPLAF.getTextColor_OK());
