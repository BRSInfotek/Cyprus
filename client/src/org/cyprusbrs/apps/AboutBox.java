...
public final class AboutBox extends CDialog implements ActionListener
{
	...
	public AboutBox(JFrame parent)
	{
		...
		//
		labelVersion.setText(Cyprus.getVersion());
		labelCopyright.setText(Cyprus.COPYRIGHT);
	...
	private void jbInit() throws Exception
	{
		...
		labelDescription.setText(Cyprus.getURL());
		//
		...
		imageControl.setIcon(Cyprus.getImageIconLogo());
		imageControl.setText(Cyprus.getSubtitle());
