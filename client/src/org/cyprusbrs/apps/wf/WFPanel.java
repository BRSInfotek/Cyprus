	...
	implements PropertyChangeListener, ActionListener, FormPanel
{
	...
	private void jbInit() throws Exception
	{
		...
		infoTextPane.setBackground(CyprusPLAF.getFieldBackground_Inactive());
	 ...
	 *  @param frame frame
	 * @see org.cyprusbrs.apps.form.FormPanel#init(int, FormFrame)
	 */
	...
	/**
	 * 	Dispose
	 * @see org.cyprusbrs.apps.form.FormPanel#dispose()
	 */
	public void dispose()
	{
		if (m_frame != null)
	...
	private void zoom()
	{
		...
		if (m_WF_Window_ID <= 0) {
			throw new CyprusException("@NotFound@ @AD_Window_ID@");
		}
	...
	{
		org.cyprusbrs.Cyprus.startupEnvironment(true);
