...
import org.cyprusbrs.grid.ed.VNumber;
...
//	private VLookup fOrg_ID;
	...
	private void statInit() throws Exception
	{
		...
		fName.setBackground(CyprusPLAF.getInfoBackground());
		...
		fCashBook_ID.setBackground(CyprusPLAF.getInfoBackground());
		...
		fInvoice_ID.setBackground(CyprusPLAF.getInfoBackground());
		...
		fBankAccount_ID.setBackground(CyprusPLAF.getInfoBackground());
		...
		fDateFrom.setBackground(CyprusPLAF.getInfoBackground());
		fDateFrom.setToolTipText(Msg.translate(Env.getCtx(), "DateFrom"));
		lDateTo.setLabelFor(fDateTo);
		fDateTo.setBackground(CyprusPLAF.getInfoBackground());
		fDateTo.setToolTipText(Msg.translate(Env.getCtx(), "DateTo"));
		lAmtFrom.setLabelFor(fAmtFrom);
		fAmtFrom.setBackground(CyprusPLAF.getInfoBackground());
		fAmtFrom.setToolTipText(Msg.translate(Env.getCtx(), "AmtFrom"));
		lAmtTo.setLabelFor(fAmtTo);
		fAmtTo.setBackground(CyprusPLAF.getInfoBackground());
