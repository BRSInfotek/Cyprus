...
import org.cyprus.plaf.CyprusTaskPaneUI;
import org.cyprusbrs.apps.AEnv;
import org.cyprusbrs.apps.ALayout;
import org.cyprusbrs.apps.ALayoutConstraint;
import org.cyprusbrs.apps.ConfirmPanel;
import org.cyprusbrs.grid.ed.VCheckBox;
import org.cyprusbrs.grid.ed.VComboBox;
import org.cyprusbrs.grid.ed.VLookup;
import org.cyprusbrs.grid.ed.VPAttribute;
...
import org.cyprusbrs.swing.CTextArea;
...
public class InfoProduct extends Info implements ActionListener, ChangeListener
{
	...
	private void statInit()
	{
		...
		fieldValue.setBackground(CyprusPLAF.getInfoBackground());
		fieldValue.addActionListener(this);
		
		labelName.setText(Msg.getMsg(Env.getCtx(), "Name"));
		fieldName.setBackground(CyprusPLAF.getInfoBackground());
		fieldName.addActionListener(this);

		labelUPC.setText(Msg.translate(Env.getCtx(), "UPC"));
		fieldUPC.setBackground(CyprusPLAF.getInfoBackground());
		fieldUPC.addActionListener(this);

		labelSKU.setText(Msg.translate(Env.getCtx(), "SKU"));
		fieldSKU.setBackground(CyprusPLAF.getInfoBackground());
		fieldSKU.addActionListener(this);
		
		labelWarehouse.setText(Msg.getMsg(Env.getCtx(), "Warehouse"));
		pickWarehouse.setBackground(CyprusPLAF.getInfoBackground());
		
		labelPriceList.setText(Msg.getMsg(Env.getCtx(), "PriceListVersion"));
		pickPriceList.setBackground(CyprusPLAF.getInfoBackground());

		labelProductCategory.setText(Msg.translate(Env.getCtx(), "M_Product_Category_ID"));
		pickProductCategory.setBackground(CyprusPLAF.getInfoBackground());
		
		// @Trifon
		labelAS.setText(Msg.translate(Env.getCtx(), "M_AttributeSet_ID"));
		pickAS.setBackground(CyprusPLAF.getInfoBackground());
		...
		fieldVendor.setBackground(CyprusPLAF.getInfoBackground());
		...
		//Begin - fer_luck @ centuryon
		//add taskpane
		fieldDescription.setBackground(CyprusPLAF.getInfoBackground());
        ...
        warehouseStockPanel.setUI(new CyprusTaskPaneUI());
