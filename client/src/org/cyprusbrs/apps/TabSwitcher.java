...
public class TabSwitcher extends FocusAdapter implements ActionListener, ListSelectionListener{
	...
	public void addTabSwitchingSupport(JComponent c) {
		...
		else if(  //c instanceof org.cyprusbrs.grid.ed.VEditor ||  				  
				   c instanceof JTextComponent ||
				   //c instanceof ItemSelectable ||
				   c instanceof org.cyprusbrs.grid.ed.VCheckBox ||
				   //c instanceof org.cyprusbrs.grid.ed.VLookup ||
				   //c instanceof org.cyprusbrs.swing.CLabel ||
		...
		else if(c instanceof org.cyprusbrs.grid.ed.VDate) 
		{
					org.cyprusbrs.grid.ed.VDate d = ((org.cyprusbrs.grid.ed.VDate)c);
					//d.addFocusListener(this);
					d.addActionListener(this);
					//d.addKeyListener(new MovementAdapter());
					return;
		}
		else if(c instanceof org.cyprusbrs.grid.ed.VLookup) 
		{
					org.cyprusbrs.grid.ed.VLookup l = ((org.cyprusbrs.grid.ed.VLookup)c);
