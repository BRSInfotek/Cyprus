 ...
 *
 *  @author     Mukesh
 *  @version    $Id: OnlineHelp.java,v 1.2 2006/07/30 00:51:27 Mukesh Exp $
 *  
...
public class OnlineHelp extends JEditorPane implements HyperlinkListener
{
	...
	protected static final String   BASE_URL = "https://cypruserp.com/login";
...
class Worker extends Thread
{
	...
	public void run()
	{
		...
		try {
			des.browse(new URI("https://cypruserp.com/login"));
