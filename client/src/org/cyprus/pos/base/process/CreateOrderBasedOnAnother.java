...
public class CreateOrderBasedOnAnother extends CreateOrderBasedOnAnotherAbstract {
    ...
    protected String doIt() throws Exception {
        ...
        targetOrder.setDocStatus(org.cyprusbrs.process.DocAction.STATUS_Drafted);
    ...
    private void createAllocations(MOrder targetOrder) {
         ...
         && totalInvoiced.compareTo(totalPay) == 0)
        {
            MAllocationHdr allocation = new MAllocationHdr(
                    ...
                    get_TrxName());
            allocation.setDocStatus(org.cyprusbrs.process.DocAction.STATUS_Drafted);
            allocation.setDocAction(org.cyprusbrs.process.DocAction.ACTION_Complete);
            allocation.saveEx();
            ...
            allocation.processIt(org.cyprusbrs.process.DocAction.ACTION_Complete);
            allocation.saveEx();
        }
    }
