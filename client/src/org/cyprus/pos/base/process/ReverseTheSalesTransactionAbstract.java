	...
	protected void prepare()
	{
		...
		for (int i = 0; i < para.length; i++)
		{
			...
			if (para[i].getParameter() == null)
				...
				orderId = ((BigDecimal)para[i].getParameter()).intValue();
				...
				isCancelled = "Y".equals(para[i].getParameter());
			else if (name.equals("IsShipConfirm"))
				isShipReceiptConfirmation = "Y".equals(para[i].getParameter());
