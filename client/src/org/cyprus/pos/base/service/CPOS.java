 ...
 *****************************************************************************/
package org.cyprus.pos.base.service;
...
import org.cyprus.pos.base.AdempierePOSException;
import org.cyprus.pos.base.command.CommandManager;
import org.cyprus.pos.base.util.POSTicketHandler;
import org.cyprusbrs.model.I_AD_User;
import org.cyprusbrs.model.I_C_OrderLine;
import org.cyprusbrs.model.MAllocationHdr;
import org.cyprusbrs.model.MAllocationLine;
...
import org.cyprusbrs.model.MInOutConfirm;
import org.cyprusbrs.model.MInOutLineConfirm;
...
import org.cyprusbrs.model.MOrderTax;
import org.cyprusbrs.model.MPOS;
import org.cyprusbrs.model.MPOSKey;
import org.cyprusbrs.model.MPayment;
import org.cyprusbrs.model.MPaymentProcessor;
import org.cyprusbrs.model.MPriceList;
import org.cyprusbrs.model.MPriceListVersion;
...
import org.cyprusbrs.model.MWarehouse;
...
import org.cyprusbrs.util.TrxRunnable;
import org.cyprusbrs.util.ValueNamePair;
import org.cyprus.pos.base.eevolution.service.dsl.ProcessBuilder;
...
//	}
	...
	public static List<Vector<Object>> getQueryProduct(String productCode, int warehouseId , int priceListId , int partnerId) {
		ArrayList<Vector<Object>> rows = new ArrayList<>();
		StringBuilder sql = new StringBuilder();
		sql.append("SELECT DISTINCT ProductPricing.M_Product_ID , p.Value, p.Name,")
				.append("   BomQtyAvailable(ProductPricing.M_Product_ID, ? , 0 ) AS QtyAvailable , PriceStd , PriceList")
					.append(" FROM M_Product p INNER JOIN (")
					.append("	SELECT pl.M_PriceList_ID , plv.ValidFrom , 0 AS BreakValue , null AS C_BPartner_ID,")
					.append("   p.M_Product_ID,")
