 ...
 *****************************************************************************/
package org.cyprus.pos.swing.grid;
...
public final class VPOSBPartner extends CDialog implements ActionListener
{
	...
	private void initBPartner()	{
		...
		//
		fName.setBackground(CyprusPLAF.getFieldBackground_Mandatory());
		fValue.setBackground(CyprusPLAF.getFieldBackground_Mandatory());
		fAddress.setBackground(CyprusPLAF.getFieldBackground_Mandatory());
	}	//	initBPartner
	...
	private boolean actionSave()
	{
		...
		{
			fValue.setBackground(CyprusPLAF.getFieldBackground_Error());
			return false;
		}
		else {
			fValue.setBackground(CyprusPLAF.getFieldBackground_Mandatory());
		...
		{
			fName.setBackground(CyprusPLAF.getFieldBackground_Error());
			return false;
		}
		...
		{
			fAddress.setBackground(CyprusPLAF.getFieldBackground_Error());
			return false;
		}
		else
			fAddress.setBackground(CyprusPLAF.getFieldBackground_Mandatory());
