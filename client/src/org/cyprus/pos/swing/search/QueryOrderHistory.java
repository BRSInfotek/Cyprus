	...
	public void setResultsFromArray(Properties ctx, boolean processed, String doc, Timestamp dateFrom, Timestamp dateTo, String bPartner, boolean aDate) {
		...
		try  {
			...
			sql.append(" SELECT o.C_Order_ID, o.DocumentNo, dt.Name AS C_DocType_ID ,")
				...
				.append("COALESCE(o.GrandTotal - (SELECT SUM(PayAmt) FROM C_Payment p WHERE p.C_Order_ID=o.C_Order_ID),null)  AS OpenAmt,")
			...
			//	Group By
			sql.append(" GROUP BY o.C_Order_ID, o.DocumentNo, o.dateordered, dt.Name , b.Name, o.GrandTotal, o.Processed, i.IsPaid, o.Updated ");
