...
import org.cyprusbrs.model.I_C_Order;
import org.cyprusbrs.model.I_C_OrderLine;
import org.cyprusbrs.model.MBPartner;
import org.cyprusbrs.model.MBPartnerInfo;
...
public class POSDocumentPanel extends POSSubPanel
	...
	public void init() {
		...
		documentTitle.setTitleColor(CyprusPLAF.getTextColor_Label());
		...
		totalTitle.setTitleColor(CyprusPLAF.getTextColor_Label());
