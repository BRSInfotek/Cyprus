...
import org.cyprus.pos.base.POSKeyboardFocusManager;
import org.cyprus.pos.base.service.CPOS;
import org.cyprus.pos.base.service.POSPanelInterface;
import org.cyprus.pos.base.service.POSScalesPanelInterface;
import org.cyprusbrs.apps.ADialog;
import org.cyprusbrs.apps.AMenuStartItem;
...
public class VPOS extends CPOS implements FormPanel, POSPanelInterface, POSScalesPanelInterface {
	...
	public VPOS() {
		...
		//	
		font = CyprusPLAF.getFont_Field().deriveFont(Font.BOLD, 12);
		plainFont = CyprusPLAF.getFont_Field().deriveFont(Font.PLAIN, 12);
		bigFont = CyprusPLAF.getFont_Field().deriveFont(Font.BOLD, 14);
		bigPlainFont = CyprusPLAF.getFont_Field().deriveFont(Font.PLAIN, 14);
