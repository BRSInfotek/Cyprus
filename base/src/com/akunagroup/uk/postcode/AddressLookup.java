/**********************************************************************
 * This file is part of Cyprus ERP Bazaar                          * 
...
import org.cyprus.util.GenerateModel;
...
public class AddressLookup implements AddressLookupInterface {
	...
	private URL buildUrl(String postcode) {
		try {
			...
			urlStr.append("DSGID=1&AmbiguityId=1&MaxReturns=250&FieldList=&ParamList=&sAppID=Cyprus&MaxReturns=200");
