 ...
 *****************************************************************************/
package org.cyprusbrs.print.layout;
...
import org.cyprusbrs.print.ArchiveEngine;
import org.cyprusbrs.print.CPaper;
import org.cyprusbrs.print.DataEngine;
import org.cyprusbrs.print.MPrintColor;
import org.cyprusbrs.print.MPrintFont;
import org.cyprusbrs.print.MPrintFormat;
import org.cyprusbrs.print.MPrintFormatItem;
import org.cyprusbrs.print.MPrintPaper;
import org.cyprusbrs.print.MPrintTableFormat;
import org.cyprusbrs.print.PrintData;
import org.cyprusbrs.print.PrintDataElement;
...
public class LayoutEngine implements Pageable, Printable, Doc
{
	...
	private void createStandardHeaderFooter()
	{
		...
		if (ci.getLogoReport_ID() > 0) {
			...
			element = new ImageElement(org.cyprusbrs.Cyprus.getImageLogoSmall(true));	//	48x15
		}
	//	element = new ImageElement(org.compiere.Adempiere.getImageLogo());	//	100x30
		...
		//
		element = new StringElement(Cyprus.ADEMPIERE_R, font, color, null, true);
