...
public class Database
{
	 ...
	 *  @return database
	 */
	public static CyprusDatabase getDatabase (String type)
	throws Exception
	{
		CyprusDatabase db = null;
		for (int i = 0; i < Database.DB_NAMES.length; i++)
		{
			if (Database.DB_NAMES[i].equals (type))
			{
				db = (CyprusDatabase)Database.DB_CLASSES[i].
					   newInstance ();
				break;
			}
		}
	 ...
	 */
	public static CyprusDatabase getDatabaseFromURL(String url)
	{
		if (url == null)
		{
