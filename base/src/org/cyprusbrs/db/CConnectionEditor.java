	...
	implements CEditor
{
	...
	public void setBackground (boolean error)
	{
		Color c = null;
		if (error)
			c = CyprusPLAF.getFieldBackground_Error();
		else if (!m_rw)
			c = CyprusPLAF.getFieldBackground_Inactive();
		else if (m_mandatory)
			c = CyprusPLAF.getFieldBackground_Mandatory();
		else
			c = CyprusPLAF.getFieldBackground_Normal();
		setBackground(c);
	}   //  setBackground
	...
	public void setDisplay()
	{
		...
		{
			m_text.setForeground(CyprusPLAF.getTextColor_OK());
			setBackground(false);
			if (!m_value.isAppsServerOK(false))
				m_server.setBackground(CyprusPLAF.getFieldBackground_Error());
			if (!m_value.isDatabaseOK())
				m_db.setBackground(CyprusPLAF.getFieldBackground_Error());
		}
		else
		{
			m_text.setForeground(CyprusPLAF.getTextColor_Issue());
			setBackground(true);
		}
	}   //  setDisplay
	...
	//	System.out.println("CConnectionEditor");
		...
		CyprusPLAF.showCenterScreen(frame);
	}   //  main
