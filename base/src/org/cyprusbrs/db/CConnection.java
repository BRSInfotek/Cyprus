...
import org.cyprus.as.ASFactory;
import org.cyprus.util.EmbeddedServerProxy;
import org.cyprusbrs.Cyprus;
import org.cyprusbrs.interfaces.Server;
import org.cyprusbrs.interfaces.Status;
...
public class CConnection implements Serializable, Cloneable
{
	...
	public final static String SERVER_EMBEDDED = "org.cyprus.server.embedded";
	...
	public static CConnection get (String apps_host)
	{
		if (s_cc == null)
		{
			...
			if (attributes == null || attributes.length () == 0)
			{
				...
				CConnection cc = null;
				if (apps_host != null && Cyprus.isWebStartClient() && !CConnection.isServerEmbedded())
				{
	...
	/** DB User name        */
	private String 		m_db_uid = "cyprus";
	/** DB User password    */
	private String 		m_db_pwd = "cyprus";

	/** Database            */
	private CyprusDatabase m_db = null;
	/** ConnectionException */
	...
	private final static String SECURITY_PRINCIPAL = "org.cyprus.security.principal";
	 ...
	 *  @return database
	 */
	public CyprusDatabase getDatabase ()
	{
		//  different driver
		...
		if (m_db == null)
		{
			try
			{
		         for (int i = 0; i < Database.DB_NAMES.length; i++)
	             {
	                     ...
	                     {
	                             m_db = (CyprusDatabase)Database.DB_CLASSES[i].
	                                        newInstance ();
	                             break;
	                     }
	             }
			...
			{
				System.err.println("Environment Error - Check cyprus.properties - " + ee);
				if (Ini.isClient())
				{
