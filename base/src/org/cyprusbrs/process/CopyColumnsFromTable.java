...
public class CopyColumnsFromTable extends SvrProcess
{
	...
	protected String doIt () throws Exception
	{
		if (p_target_AD_Table_ID == 0)
			throw new CyprusSystemError("@NotFound@ @AD_Table_ID@ " + p_target_AD_Table_ID);
		if (p_source_AD_Table_ID == 0)
			throw new CyprusSystemError("@NotFound@ @AD_Table_ID@ " + p_source_AD_Table_ID);
		...
		if (targetColumns.length > 0)
			...
			throw new CyprusSystemError("Target table must not have columns");
