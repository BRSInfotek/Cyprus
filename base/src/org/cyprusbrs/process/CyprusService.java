 ...
 */
public class CyprusService extends StateEngine
{
	/**
	 * 	Adempiere Service
	 ...
	 */
	public CyprusService (PO processor, Class<?> serverClass)
	{
		super ();
	...
	/**	Adempiere Server(s)			*/
	private CyprusServer	m_server = null;
	 ...
	 */
	public CyprusServer getCompierServer()
	{
		getState();
		return m_server;
	}	//	getCyprusServer
	...
	public boolean start()
	{
		...
		try
		{
			m_server = (CyprusServer)m_serverClass.newInstance();
