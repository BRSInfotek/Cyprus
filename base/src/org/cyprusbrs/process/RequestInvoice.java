...
import org.cyprusbrs.model.MRequestUpdate;
...
public class RequestInvoice extends SvrProcess
{
	...
	protected String doIt () throws Exception
	{
		...
		if (type.get_ID() == 0)
			throw new CyprusSystemError("@R_RequestType_ID@ @NotFound@ " + p_R_RequestType_ID);
		if (!type.isInvoiced())
			throw new CyprusSystemError("@R_RequestType_ID@ <> @IsInvoiced@");
