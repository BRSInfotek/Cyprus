...
import org.cyprusbrs.model.MDunningLevel;
import org.cyprusbrs.model.MDunningRun;
import org.cyprusbrs.model.MDunningRunEntry;
...
public class DunningPrint extends SvrProcess
{
	...
	protected String doIt () throws Exception
	{
		...
		if (p_EMailPDF && p_R_MailText_ID == 0)
			throw new CyprusUserError ("@NotFound@: @R_MailText_ID@");
//		String subject = "";
		...
		if (p_EMailPDF)
		{
			...
			if (p_EMailPDF && mText.get_ID() == 0)
				throw new CyprusUserError ("@NotFound@: @R_MailText_ID@ - " + p_R_MailText_ID);
//			subject = mText.getMailHeader();
		}
		//
		MDunningRun run = new MDunningRun (getCtx(), p_C_DunningRun_ID, get_TrxName());
		if (run.get_ID() == 0)
			throw new CyprusUserError ("@NotFound@: @C_DunningRun_ID@ - " + p_C_DunningRun_ID);
