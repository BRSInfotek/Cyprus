...
import org.cyprus.exceptions.InvoiceFullyMatchedException;
...
public class InvoiceCreateInOut extends SvrProcess
{
	...
	protected String doIt () throws Exception
	{
		...
		if (invoice.get_ID() <= 0)
			throw new CyprusException("@NotFound@ @C_Invoice_ID@");
		if (!MInvoice.DOCSTATUS_Completed.equals(invoice.getDocStatus()))
			throw new CyprusException("@InvoiceCreateDocNotCompleted@");
		//
