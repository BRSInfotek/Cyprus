...
import org.cyprusbrs.model.MRoleOrgAccess;
...
public class BPartnerOrgLink extends SvrProcess
{
	...
	protected String doIt() throws Exception
	{
		...
		if (p_C_BPartner_ID == 0)
			throw new CyprusUserError ("No Business Partner ID");
		MBPartner bp = new MBPartner (getCtx(), p_C_BPartner_ID, get_TrxName());
		if (bp.get_ID() == 0)
			throw new CyprusUserError ("Business Partner not found - C_BPartner_ID=" + p_C_BPartner_ID);
		//	BP Location
