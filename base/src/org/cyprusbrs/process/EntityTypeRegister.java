...
public class EntityTypeRegister extends SvrProcess
{
		...
		throws Exception
	{
		...
		if (et.isSystemMaintained())
			throw new CyprusUserError("You cannot register a System maintained entity");
		
		throw new CyprusSystemError("To register an Entity Type, contact Adempiere directly");
