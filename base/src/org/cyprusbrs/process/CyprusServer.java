 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: CyprusServer.java,v 1.2 2006/07/30 00:54:44 jjanke Exp $
 */
public abstract class CyprusServer extends Thread
{
	 ...
	 */
	public CyprusServer (String name)
	{
		super (s_threadGroup, name);
	}	//	CyprusServer

	/**	Thread Group			*/
	private static ThreadGroup	s_threadGroup = new ThreadGroup("CyprusServer");
	...
	{
		StringBuffer sb = new StringBuffer ("CyprusServer[");
