...
import org.cyprusbrs.model.MProductPO;
...
public class RequisitionPOCreate extends SvrProcess
{
	...
	protected String doIt() throws Exception
	{
		...
		if (p_M_Requisition_ID != 0)
		{
			...
			{
				throw new CyprusUserError("@DocStatus@ = " + req.getDocStatus());
			}
	...
	private void newLine(MRequisitionLine rLine) throws Exception
	{
		...
		else if (rLine.getC_Charge_ID() != 0)
		{
			...
			if (C_BPartner_ID == 0)
			{
				throw new CyprusUserError("No Vendor for Charge " + charge.getName());
			}
		}
		else
		{
