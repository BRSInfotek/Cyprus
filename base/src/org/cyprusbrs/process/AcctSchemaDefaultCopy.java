...
public class AcctSchemaDefaultCopy extends SvrProcess
{
	...
	protected String doIt () throws Exception
	{
		...
		if (p_C_AcctSchema_ID == 0)
			throw new CyprusSystemError("C_AcctSchema_ID=0");
		MAcctSchema as = MAcctSchema.get(getCtx(), p_C_AcctSchema_ID);
		if (as.get_ID() == 0)
			throw new CyprusSystemError("Not Found - C_AcctSchema_ID=" + p_C_AcctSchema_ID);
		MAcctSchemaDefault acct = MAcctSchemaDefault.get (getCtx(), p_C_AcctSchema_ID);
		if (acct == null || acct.get_ID() == 0)
			throw new CyprusSystemError("Default Not Found - C_AcctSchema_ID=" + p_C_AcctSchema_ID);
