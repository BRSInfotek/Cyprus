...
public class CLogMgt
{
	...
	public static void initialize(boolean isClient)
	{
		...
		catch (Exception e)
		{
			...
			java.lang.ClassNotFoundException: org.compiere.util.CLogConsole
				...
				at org.compiere.Cyprus.startup(Cyprus.java:389)
				at org.compiere.Cyprus.main(Cyprus.java:500)
	...
	public static StringBuffer getInfo (StringBuffer sb)
	{
		...
		sb.append(getMsg("ImplementationVendor")).append(eq).append(org.cyprusbrs.Cyprus.getImplementationVendor()).append(NL);
		sb.append(getMsg("ImplementationVersion")).append(eq).append(org.cyprusbrs.Cyprus.getImplementationVersion()).append(NL);
		//
		sb.append("CyprusHome = ").append(Cyprus.getCyprusHome()).append(NL);
		sb.append("CyprusProperties = ").append(Ini.getPropertyFileName()).append(NL);
		...
		sb.append(Cyprus.getJavaInfo()).append(NL);
		sb.append("java.io.tmpdir="+System.getProperty("java.io.tmpdir")).append(NL);
		sb.append(Cyprus.getOSInfo()).append(NL);
	...
	public static StringBuffer getInfoDetail (StringBuffer sb, Properties ctx)
	{
		...
		sb.append(NL)
			.append("=== Environment === ")
			.append(Cyprus.getCheckSum()).append(NL)
			.append(Cyprus.getSummaryAscii()).append(NL)
