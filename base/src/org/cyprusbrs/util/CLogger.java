...
public class CLogger extends Logger implements Serializable
{
	...
	private static final String LAST_INFO = "org.cyprusbrs.util.CLogger.lastInfo";
	private static final String LAST_WARNING = "org.cyprusbrs.util.CLogger.lastWarning";
	private static final String LAST_ERROR = "org.cyprusbrs.util.CLogger.lastError";
	private static final String LAST_EXCEPTION = "org.cyprusbrs.util.CLogger.lastException";
    ...
    {
    	if (s_logger == null)
    		s_logger = getCLogger("org.cyprusbrs.default");
    	return s_logger;
    }	//	get
