...
public class Login
{
	...
	//	logger.entering("Env", "initTest");
		if (!Cyprus.startupEnvironment(true))
			System.exit (1);
		//  Test Context
	...
	public static boolean isJavaOK (boolean isClient)
	{
		...
		if (jVersion.startsWith("1.5.0"))
			...
			return true;
                if (jVersion.startsWith("1.8.0")) /// Update the Java Version by Mukesh
        			return true;
                if (jVersion.startsWith("1.13.0")) /// Update the Java Version by Mukesh
        			return true;
                //end
		//  Warning
		boolean ok = false;
	...
	//		ok = true;
		...
		if (isClient)
			JOptionPane.showMessageDialog(null, msg.toString(),
				org.cyprusbrs.Cyprus.getName() + " - Java Version Check",
...
//		boolean loginWithValue = M_Element.get(Env.getCtx(), I_AD_User.COLUMNNAME_IsLoginUser) != null;
		// @20210303 Above code commented because Value has completely changed according to Name So we will consider Name is Primary thing need to check 
	...
	private KeyNamePair[] getRoles (String app_user, String app_pwd, boolean force)
	{
		...
		//	Added by Mukesh to Authenticate the User and Pwd @20210302
...
//			}
	 ...
	 *	@param role role
	 *	@see org.cyprusbrs.model.MRole#loadOrgAccessAdd
	 */
