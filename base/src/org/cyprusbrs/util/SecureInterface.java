...
/**
 * 	CYPRUS Security Interface.
 * 	To enable your own class, you need to set the property CYPRUS_SECURE 
 * 	when starting the client or server.
 *  The setting for the default class would be:
 *  -DCYPRUS_SECURE=org.cyprusbrs.util.Secure
 *	
 *  @author Jorg Janke
...
public interface SecureInterface
{
	...
	public static final String	CYPRUS_SECURE = "CYPRUS_SECURE";
	/** Default Class Name implementing SecureInterface	*/
	public static final String	CYPRUS_SECURE_DEFAULT = "org.cyprusbrs.util.Secure";
