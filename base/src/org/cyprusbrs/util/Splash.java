...
public class Splash extends Frame
{
	...
	private void jbInit() throws Exception
	{
		...
		productLabel.setText(Cyprus.getSubtitle());
	...
	private class AImage extends Component
	{
		...
		{
			super();
			URL url = org.cyprusbrs.Cyprus.class.getResource("images/Java_anim.gif");
			if (url == null)
				url = org.cyprusbrs.Cyprus.class.getResource("images/Java_logo.gif");
			if (url != null)
			{
