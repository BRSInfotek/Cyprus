 ...
 */
public class CyprusSystemError extends Exception
{
	/**
	 * 
	 */
	 ...
	 */
	public CyprusSystemError (String message)
	{
		super (message);
	 ...
	 *	@param detail detail
	 */
	public CyprusSystemError (String message, Object detail)
	{
		super (message);
		setDetail (detail);
	}	//	AdempiereSystemError
	 ...
	 *	@param cause
	 */
	public CyprusSystemError (String message, Throwable cause)
	{
		super (message, cause);
	}	//	AdempiereSystemError
