 ...
 */
public class CyprusUserError extends Exception
{
	/**
	 * 
	 */
	 ...
	 */
	public CyprusUserError (String message)
	{
		super (message);
	}	//	AdempiereUserError
	 ...
	 */
	public CyprusUserError (String message, String fixHint)
	{
		super (message);
		setFixHint(fixHint);
	}	//	AdempiereUserError
	 ...
	 *	@param cause
	 */
	public CyprusUserError (String message, Throwable cause)
	{
		super (message, cause);
	}	//	AdempiereUserError
