...
public class WebDoc
{
	...
	private void setUp (boolean plain, boolean javaClient, String title)
	{
		...
		if (javaClient) {
	//	m_topRight.addElement(new img("res:org/cyprusbrs/images/CB10030.png")
			m_topRight.addElement("Cyprus").setAlign(AlignType.RIGHT);
		//	.setAlign(AlignType.RIGHT).setAlt("Cyprus"));
		} else {
			if (title.equals("")) {
