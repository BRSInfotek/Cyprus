...
public class WebUser
{
	...
	private void load (String email, String password)
	{
		...
		//	We have a password
		if (m_bpc != null && password != null && authenticateHash(password))/// by Mukesh @20210301 //&& password.equals(m_bpc.getPassword()))
			m_passwordOK = true;
...
//			 && password.equals (getPassword ());   /// Commented by Mukesh
			 && authenticateHash(password);  // Added by Mukesh @20210301
