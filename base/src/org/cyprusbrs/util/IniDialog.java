...
public final class IniDialog extends JDialog implements ActionListener
{
	...
	public IniDialog()
	{
		...
		{
			jbInit();
			String where = "org/cyprusbrs/license.html";
			URL url = null;
...
//				url = new URL("http://www.adempiere.org/license.html");
			}
			if (url == null)
				cmd_reject();
			//
	...
	/** Translation     */
	static ResourceBundle   s_res = ResourceBundle.getBundle("org.cyprusbrs.util.IniRes");
	...
	private JButton bReject = CyprusPLAF.getCancelButton();
	private JButton bAccept = CyprusPLAF.getOKButton();
	...
	{
		setTitle("Cyprus - " + s_res.getString("Adempiere_License"));
//		setTitle("Cyprus - " + s_res.getString("Cyprus_License"));
