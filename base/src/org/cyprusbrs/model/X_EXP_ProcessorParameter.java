...
public class X_EXP_ProcessorParameter extends PO implements I_EXP_ProcessorParameter, I_Persistent 
{
	...
	public org.cyprusbrs.model.I_EXP_Processor getEXP_Processor() throws RuntimeException
    {
		return (org.cyprusbrs.model.I_EXP_Processor)MTable.get(getCtx(), org.cyprusbrs.model.I_EXP_Processor.Table_Name)
