...
public int getC_Tax_ID () 
{
	...
	@Override
	public I_C_Currency getC_Tax() throws RuntimeException {
		// TODO Auto-generated method stub
		return null;
	}
	
	// implemented by Anshul@09032022
	
	public void setIsMultiCharge (boolean IsMultiCharge)
	{
		set_Value (COLUMNNAME_IsMultiCharge, Boolean.valueOf(IsMultiCharge));
	}

	
	public boolean IsMultiCharge () 
	{
		Object oo = get_Value(COLUMNNAME_IsMultiCharge);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	public org.cyprusbrs.model.I_C_POS getC_POS() throws RuntimeException
    {
		return (org.cyprusbrs.model.I_C_POS)MTable.get(getCtx(), org.cyprusbrs.model.I_C_POS.Table_Name)
