	...
	implements Serializable
{
	...
	public PP_PayFlowPro()
	{
		super();
		m_pp = new PFProAPI();
		String path = Ini.getCyprusHome() + File.separator + "lib";
	...
	public boolean process (String parameter)
	{
		...
		//	RESULT=-31&RESPMSG=The certificate chain did not validate, no local certificate found, javax.net.ssl.SSLException: Cert Path = C:\Cyprus\lib, Working Directory = C:\Cyprus\adempiere-all2\client\temp
