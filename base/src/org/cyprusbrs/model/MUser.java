...
import org.cyprusbrs.util.Secure;
...
public class MUser extends X_AD_User
{
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		/// Below code updated by Mukesh @20210302
	...
	//// Below code updated from Adempiere 3.9.3 for cryptography for password  @20210301
    ...
    public static boolean authenticateHash (final String password, final String hash,final  String salt) {
        try {
         ...
         throw new CyprusException("Password hashing not supported by JVM");
	...
	// end of code by Mukesh @20210301
