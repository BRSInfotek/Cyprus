...
//	private static CLogger		s_log = CLogger.getCLogger (MLanguage.class);
	...
	private int addTable (String tableName)
	{
		...
		String insert = "INSERT INTO " + tableName
			+ "(AD_Language,IsTranslated, AD_Client_ID,AD_Org_ID,CREATED,UPDATED, " /// CREATED, UPDATED, updated by Mukesh @20220309
			+ "Createdby,UpdatedBy, "
			+ keyColumn + cols + ") "
			+ "SELECT '" + getAD_Language() + "','N', AD_Client_ID,AD_Org_ID,CREATED,UPDATED, "  /// CREATED, UPDATED, updated by Mukesh @20220309
