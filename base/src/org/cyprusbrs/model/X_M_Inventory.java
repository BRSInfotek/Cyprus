 ...
 *  @version Release 3.6.1 Supported By Cyprus - $Id$ */
...
// @#Date@
	...
	/** Set IsInternalUse.
		@param IsInternalUse 
		This is new fields for Cyprus ERP
	  */
	public void setIsInternalUse (boolean IsInternalUse)
	{
		set_Value (COLUMNNAME_IsInternalUse, Boolean.valueOf(IsInternalUse));
	}

	/** Get IsInternalUse.
		@return This is new fields for Cyprus ERP
	  */
	public boolean isInternalUse () 
	{
		Object oo = get_Value(COLUMNNAME_IsInternalUse);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set IS Opening Stock.
	@param ISOpeningStock IS Opening Stock	  */
public void setISOpeningStock (boolean ISOpeningStock)
{
	set_Value (COLUMNNAME_ISOpeningStock, Boolean.valueOf(ISOpeningStock));
}
	
	/** Get IS Opening Stock.
	@return IS Opening Stock	  */
public boolean isOpeningStock () 
{
	Object oo = get_Value(COLUMNNAME_ISOpeningStock);
	if (oo != null) 
	{
		 if (oo instanceof Boolean) 
			 return ((Boolean)oo).booleanValue(); 
