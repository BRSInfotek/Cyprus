...
// @SQL=SELECT COALESCE(MAX(Line),0)+10 AS DefaultValue FROM C_CashLine WHERE C_Cash_ID=@C_Cash_ID@
	...
	/** PaymentType AD_Reference_ID=1000000 */
	public static final int PAYMENTTYPE_AD_Reference_ID=1000000;
	/** Outward = P */
	public static final String PAYMENTTYPE_Outward = "P";
	/** Inward = R */
	public static final String PAYMENTTYPE_Inward = "R";
	/** Set PaymentType.
