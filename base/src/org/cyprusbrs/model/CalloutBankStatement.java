...
public class CalloutBankStatement extends CalloutEngine
{
	 ...
	 *  Callout path : org.compiere.model.CalloutBankStatement.openingBalance
	 */
	public String openingBalance (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value)
	{
		if (isCalloutActive())		//	assuming it is resetting value
			return "";
		BigDecimal openingAmount = (BigDecimal)mTab.getValue(org.cyprusbrs.model.MBankAccount.COLUMNNAME_OpeningBalance);
		mTab.setValue(org.cyprusbrs.model.MBankAccount.COLUMNNAME_CurrentBalance, openingAmount);
		return "";
	}
