...
public class MCashLine extends X_C_CashLine
{
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		**/
		...
		/// Code start by Mukesh @20210311
		// update Statement Amount, Transaction amt, Charge Amt and Interest Amount by Mukesh @20210113 
		if ((newRecord || is_ValueChanged(MCashLine.COLUMNNAME_Amount)))	//	allow different org for charge
		setAmount(UtilPayment.getRoundingAmountFromStdPrecision(getAmount(),getC_Currency_ID()));
		// End Code
...
//		if(getAmount().compareTo(Env.ZERO) != 0 || is_ValueChanged(MCashLine.COLUMNNAME_C_Tax_ID))
		if(getCashType() == "C" || is_ValueChanged(MCashLine.COLUMNNAME_C_Tax_ID))
		{
