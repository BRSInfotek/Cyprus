...
public class X_EXP_Processor extends PO implements I_EXP_Processor, I_Persistent 
{
	...
	public org.cyprusbrs.model.I_EXP_Processor_Type getEXP_Processor_Type() throws RuntimeException
    {
		return (org.cyprusbrs.model.I_EXP_Processor_Type)MTable.get(getCtx(), org.cyprusbrs.model.I_EXP_Processor_Type.Table_Name)
