...
public class CalloutCashJournal extends CalloutEngine
{
	...
	/**
	 *  /// Below code updated by Mukesh @20210312 as per discussed by Surya
	 *  Callout path : org.compiere.model.CalloutCashJournal.openingBalance
	 */
	public String openingBalance (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value)
	{
		if (isCalloutActive())		//	assuming it is resetting value
			return "";
		BigDecimal openingAmount = (BigDecimal)mTab.getValue(org.cyprusbrs.model.MCashBook.COLUMNNAME_OpeningBalance);
		mTab.setValue(org.cyprusbrs.model.MCashBook.COLUMNNAME_CurrentBalance, openingAmount);
		return "";
	}
	
	/**
	 *  /// Below code updated by Anshul @20210617 as per discussed by Surya
	 *  Callout path : org.compiere.model.CalloutCashJournal.currentBalance
	 *  changes made as per excel sheet provided by Mukesh
	 */
	public String currentBalance (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value)
	{
		if (value == null)
			return "";
		int C_CashBook_ID = ((Integer)value).intValue();
		MCashBook ba = MCashBook.get(ctx, C_CashBook_ID);
		mTab.setValue(org.cyprusbrs.model.MCash.COLUMNNAME_BeginningBalance, ba.getCurrentBalance());
		return "";
	}	//	CashBook
