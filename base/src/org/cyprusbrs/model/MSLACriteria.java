...
import org.cyprusbrs.sla.SLACriteria;
...
public class MSLACriteria extends X_PA_SLA_Criteria
{
	...
	public SLACriteria newInstance() throws Exception
	{
		if (getClassname() == null || getClassname().length() == 0)
			throw new CyprusSystemError("No SLA Criteria Classname");
		...
		{
			throw new CyprusSystemError("Could not intsnciate SLA Criteria", e);
		}
	}	//	newInstance
