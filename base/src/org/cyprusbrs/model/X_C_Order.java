...
import org.cyprus.crm.model.I_C_SalesOpportunity;
...
// 5
	...
	/** Set Create Sales Order.
		@param CreateSalesOrder 
		This button used to create the Sales Order by Sales Quotation window
	  */
	public void setCreateSalesOrder (String CreateSalesOrder)
	{
		set_Value (COLUMNNAME_CreateSalesOrder, CreateSalesOrder);
	}

	/** Get Create Sales Order.
		@return This button used to create the Sales Order by Sales Quotation window
	  */
	public String getCreateSalesOrder () 
	{
		return (String)get_Value(COLUMNNAME_CreateSalesOrder);
	}
