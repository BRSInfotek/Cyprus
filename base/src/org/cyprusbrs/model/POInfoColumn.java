...
public class POInfoColumn implements Serializable
{
		...
		boolean isTranslated, boolean isEncrypted, boolean isAllowLogging)
	{
		...
		{
			DisplayType = org.cyprusbrs.util.DisplayType.String;
		...
		{
			DisplayType = org.cyprusbrs.util.DisplayType.ID;
			ColumnClass = Integer.class;
		}
		else
			ColumnClass = org.cyprusbrs.util.DisplayType.getClass(displayType, true);
