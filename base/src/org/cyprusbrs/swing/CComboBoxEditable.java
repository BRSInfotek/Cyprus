...
import org.cyprusbrs.plaf.CompiereComboBoxUI;
	...
	public void addMouseListener (MouseListener ml)
	{
		...
		if (getUI() instanceof CompiereComboBoxUI && !Trace.getCallerClass(1).startsWith("javax"))
		{
			...
			if (b != null)
                ...
                if (getUI() instanceof org.cyprus.plaf.CyprusComboBoxUI && !Trace.getCallerClass(1).startsWith("javax"))
		{
			JButton b = ((org.cyprus.plaf.CyprusComboBoxUI)getUI()).getArrowButton();
			if (b != null)
				b.addMouseListener(ml);
		}
