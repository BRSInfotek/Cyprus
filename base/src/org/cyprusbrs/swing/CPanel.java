...
public class CPanel extends JPanel
{
	...
	{
		if (bg == null)
			bg = new CompiereColor(CyprusPLAF.getFormBackground());
	...
	{
		if (level == 0)
			putClientProperty(CyprusLookAndFeel.TABLEVEL, null);
		else
			putClientProperty(CyprusLookAndFeel.TABLEVEL, new Integer(level));
	}   //  setTabLevel
