...
public abstract class Doc
{
	 ...
	 */
	public static Doc get (MAcctSchema[] ass, int AD_Table_ID, ResultSet rs, String trxName) throws CyprusUserError
	{
		Doc doc = null;
		...
		String packageName = "org.cyprusbrs.acct";
		...
		catch (Exception e)
		{
			...
			throw new CyprusUserError("Doc Class invalid: " + className + " (" + e.toString() + ")");
		}
