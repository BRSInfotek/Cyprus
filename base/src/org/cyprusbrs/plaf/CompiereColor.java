...
import org.cyprusbrs.swing.ThemeUtils;
...
public class CompiereColor implements Serializable
{
	...
	/** Names   */
	private static ResourceBundle   s_res = ResourceBundle.getBundle("org.cyprusbrs.plaf.PlafRes");
	...
	{
		setBackground (c, new CompiereColor(CyprusPLAF.getFormBackground()));
	}   //  setBackground
	...
	{
		setBackground (win, new CompiereColor(CyprusPLAF.getFormBackground()));
	}   //  setBackground
	...
	{
		return new CompiereColor(CyprusPLAF.getFormBackground());
