...
import org.cyprus.pos.util.AbstractBatchImport;
import org.cyprusbrs.model.I_AD_ImpFormat;
import org.cyprusbrs.model.X_AD_ImpFormat;
import org.cyprusbrs.model.X_I_GLJournal;
...
//				retValue.setSeparatorChar(rs.getString(I_AD_ImpFormat.COLUMNNAME_SeparatorChar));
				/// below code updated by Mukesh @20210706 As bug while upload import format
