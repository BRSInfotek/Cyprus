...
public class X_AD_ContextInfo extends PO implements I_AD_ContextInfo, I_Persistent 
{
	...
	public org.cyprusbrs.model.I_AD_Message getAD_Message() throws RuntimeException
    {
		return (org.cyprusbrs.model.I_AD_Message)MTable.get(getCtx(), org.cyprusbrs.model.I_AD_Message.Table_Name)
