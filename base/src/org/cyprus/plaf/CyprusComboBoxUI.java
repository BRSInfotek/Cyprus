 ...
 */
public class CyprusComboBoxUI extends PlasticComboBoxUI
{
	/**
	 *  Create UI
	 *  @param c
	 ...
	 *  @see org.cyprusbrs.swing.CComboBox#addMouseListener(MouseListener)
	 *  @param c componrnt
	 */
	...
	{
		CyprusComboPopup newPopup = new CyprusComboPopup( comboBox );
