 ...
 */
public class CyprusTheme extends com.jgoodies.looks.plastic.PlasticTheme {
	...
	static
	{
		s_theme = new org.cyprus.plaf.CyprusTheme();
	}
	...
	/**	Logger					*/
	protected static Logger 	log = Logger.getLogger(org.cyprus.plaf.CyprusTheme.class.getName());
	/** Active Theme			*/
	protected static CyprusTheme	s_theme = null;
