 ...
 */
public class CyprusLabelUI extends MetalLabelUI
{
	/** Singleton				*/
    protected static CyprusLabelUI cyprusLabelUI = new CyprusLabelUI();
     ...
     *	@return singleton
     */
    public static CyprusLabelUI createUI(JComponent c) 
    {
    	return cyprusLabelUI;
    }	//	createUI
