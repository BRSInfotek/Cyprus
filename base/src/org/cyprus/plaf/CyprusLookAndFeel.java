 ...
 */
public class CyprusLookAndFeel extends com.jgoodies.looks.plastic.Plastic3DLookAndFeel
{
	/**
	 * 
	 */
	...
	private void putDefault (UIDefaults table, String uiKey)
	{
		try
		{
			String className = "org.cyprus.plaf.Cyprus" + uiKey;
