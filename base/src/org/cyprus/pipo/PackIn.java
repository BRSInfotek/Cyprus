...
import org.cyprusbrs.model.X_AD_Package_Imp_Proc;
...
public class PackIn extends SvrProcess {
	...
	protected String doIt() throws Exception {
		...
		if (packageDirectory == null || packageDirectory.trim().length() == 0) {
			packageDirectory = Cyprus.getCyprusHome();
		}
		...
		// "org.cyprusbrs.model","'U'"};
		// org.cyprusbrs.util.GenerateModel.main(args) ;
	...
	public static void main(String[] args) {
		...
		PackIn packIn = new PackIn();
		// org.cyprusbrs.Compiere.startupEnvironment(true);
