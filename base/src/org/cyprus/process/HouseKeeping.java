...
import org.cyprusbrs.model.X_AD_HouseKeeping;
...
public class HouseKeeping extends SvrProcess{
	...
	protected String doIt() throws Exception {
		...
		if (houseKeeping.isSaveInHistoric()){
			...
			if (noins == -1)
				throw new CyprusSystemError("Cannot insert into hst_"+tableName);
		...
		if (nodel == -1)
			throw new CyprusSystemError("Cannot delete from " + tableName);
