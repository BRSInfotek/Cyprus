...
import org.cyprusbrs.model.X_I_PriceList;
import org.cyprusbrs.model.X_M_ProductPriceVendorBreak;
...
public class ImportPriceList extends SvrProcess
{
	...
	protected String doIt() throws Exception
	{
		...
		if (m_discountschema_id <= 0)
			throw new CyprusUserError("Price List Schema not configured");
