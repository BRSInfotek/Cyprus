 ...
 *********************************************************************/
package org.cyprus.process.rpl.imp;
...
import org.cyprus.process.rpl.XMLHelper;
import org.cyprus.process.rpl.exp.ExportHelper;
import org.cyprusbrs.model.I_AD_Client;
import org.cyprusbrs.model.MClient;
import org.cyprusbrs.model.MColumn;
import org.cyprusbrs.model.MEXPFormat;
import org.cyprusbrs.model.MEXPFormatLine;
import org.cyprusbrs.model.MReplicationStrategy;
import org.cyprusbrs.model.MTable;
import org.cyprusbrs.model.ModelValidator;
import org.cyprusbrs.model.PO;
import org.cyprusbrs.model.Query;
import org.cyprusbrs.model.X_AD_ReplicationDocument;
import org.cyprusbrs.model.X_AD_ReplicationTable;
...
public class ImportHelper {
	...
	private PO getObjectFromFormat(Properties ctx, MEXPFormat expFormat, Element rootElement, String rootNodeName, String trxName) throws Exception
	{
		...
		{
			throw new CyprusException(Msg.getMsg(ctx, "EXPFormatLineNoUniqueColumns"));
		}
		...
		{
			throw new CyprusException(Msg.getMsg(ctx, "EXPFormatLineNoUniqueColumns") + " : " +expFormat.getName() + "(" +formatLines+")");
		}
