...
import org.cyprusbrs.model.MEntityType;
...
public class ModelInterfaceGenerator
{
	...
	private String createHeader(int AD_Table_ID, StringBuffer sb, StringBuffer mandatory) {
		...
		start.append("/** Generated Interface for ").append(tableName).append("\n")
			 ...
			 .append(" *  @version ").append(Cyprus.MAIN_VERSION).append(NL) //.append(" - ").append(s_run).append("\n")
			 .append(" */\n")
...
//		String directory = "C:\\Adempiere\\adempiere-all\\extend\\src\\compiere\\model\\";
		String directory="D:\\CyprusAdempiere\\Model\\ModelInterface"; /// Updated by Mukesh @20210301
		if (args.length > 0)
			directory = args[0];
...
//		String packageName = "cyprusbrs.model";
		String packageName = "org.cyprusbrs.model";  /// Updated by Mukesh	@20210301	
		if (args.length > 1)
			packageName = args[1];
...
//		String tableLike = "'%'";	//	All tables
		String tableLike = "'C_BankAccount'";	//	All tables
