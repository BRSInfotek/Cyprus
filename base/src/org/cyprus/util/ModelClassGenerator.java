...
public class ModelClassGenerator
{
	...
	private String createHeader (int AD_Table_ID, StringBuffer sb, StringBuffer mandatory, String packageName)
	{
		...
		if (!packageName.equals("org.cyprusbrs.model"))
			addImportClass("org.cyprusbrs.model.*");
		createImports(start);
		//	Class
		start.append("/** Generated Model for ").append(tableName).append(NL)
			 .append(" *  @author Adempiere (generated) ").append(NL)
			 .append(" *  @version ").append(Cyprus.MAIN_VERSION).append(" - $Id$ */").append(NL)
...
//			 .append("    protected BigDecimal accessLevel = BigDecimal.valueOf(").append(accessLevel).append(");").append(NL)
		...
		int AD_Table_ID)
	{
		...
		if (clazz.equals(Integer.class)) {
			...
			addImportClass(org.cyprusbrs.util.Env.class);
		}
		else if (clazz.equals(Boolean.class)) {
	...
	private StringBuffer createKeyNamePair (String columnName, int displayType)
	{
		...
		StringBuffer sb = new StringBuffer(NL)
			...
			.append("    }").append(NL)
		;
		addImportClass(org.cyprusbrs.util.KeyNamePair.class);
		return sb;
	}	//	createKeyNamePair
...
//		String directory = "C:\\Adempiere\\adempiere-all\\extend\\src\\compiere\\model\\";
		...
		//	second parameter
//		String packageName = "cyprusbrs.model";
		String packageName = "org.cyprusbrs.model";  /// Updated by Mukesh
...
//		String entityType = "'U'";	//	User, Application 	@20210301
		...
		tableLike = "'C_BankAccount'";	//	All tables // updated by Mukesh @20210301
