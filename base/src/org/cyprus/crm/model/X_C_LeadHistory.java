...
/** Generated Model for C_LeadHistory
 *  @author Adempiere (generated) 
 *  @version Release 1.1 Supported By Cyprus - $Id$ */
public class X_C_LeadHistory extends PO implements I_C_LeadHistory, I_Persistent 
{
    ...
    public X_C_LeadHistory (Properties ctx, int C_LeadHistory_ID, String trxName)
    {
      super (ctx, C_LeadHistory_ID, trxName);
      /** if (C_LeadHistory_ID == 0)
        {
			setC_LeadHistory_ID (0);
        } */
    }

    /** Load Constructor */
    public X_C_LeadHistory (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_LeadHistory[")
	...
	/** Set Lead HIstory ID.
		@param C_LeadHistory_ID Lead HIstory ID	  */
	public void setC_LeadHistory_ID (int C_LeadHistory_ID)
	{
		if (C_LeadHistory_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_C_LeadHistory_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_C_LeadHistory_ID, Integer.valueOf(C_LeadHistory_ID));
	}

	/** Get Lead HIstory ID.
		@return Lead HIstory ID	  */
	public int getC_LeadHistory_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_LeadHistory_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
