...
public class X_C_LeadQualification extends PO implements I_C_LeadQualification, I_Persistent 
{
    ...
    public X_C_LeadQualification (Properties ctx, int C_LeadQualification_ID, String trxName)
    {
      super (ctx, C_LeadQualification_ID, trxName);
    ...
    /** Load Constructor */
    public X_C_LeadQualification (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_LeadQualification[")
	...
	public void setC_LeadQualification_ID (int C_LeadQualification_ID)
	{
		if (C_LeadQualification_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_C_LeadQualification_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_C_LeadQualification_ID, Integer.valueOf(C_LeadQualification_ID));
	}
