...
/** Generated Model for C_OpportunityLine
 *  @author Adempiere (generated) 
 *  @version Release 1.1 Supported By Cyprus - $Id$ */
public class X_C_OpportunityLine extends PO implements I_C_OpportunityLine, I_Persistent 
{
    ...
    public X_C_OpportunityLine (Properties ctx, int C_OpportunityLine_ID, String trxName)
    {
      super (ctx, C_OpportunityLine_ID, trxName);
      /** if (C_OpportunityLine_ID == 0)
        {
			setC_OpportunityLine_ID (0);
        } */
    }

    /** Load Constructor */
    public X_C_OpportunityLine (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_OpportunityLine[")
	...
	public I_C_LeadInfo getC_LeadInfo() throws RuntimeException
    {
		return (I_C_LeadInfo)MTable.get(getCtx(), I_C_LeadInfo.Table_Name)
			.getPO(getC_LeadInfo_ID(), get_TrxName());	}

	/** Set Lead Info.
		@param C_LeadInfo_ID Lead Info	  */
	public void setC_LeadInfo_ID (int C_LeadInfo_ID)
	{
		if (C_LeadInfo_ID < 1) 
			set_Value (COLUMNNAME_C_LeadInfo_ID, null);
		else 
			set_Value (COLUMNNAME_C_LeadInfo_ID, Integer.valueOf(C_LeadInfo_ID));
	}
	...
	/** Set Opportunity Line.
		@param C_OpportunityLine_ID Opportunity Line	  */
	public void setC_OpportunityLine_ID (int C_OpportunityLine_ID)
	{
		if (C_OpportunityLine_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_C_OpportunityLine_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_C_OpportunityLine_ID, Integer.valueOf(C_OpportunityLine_ID));
	}

	/** Get Opportunity Line.
		@return Opportunity Line	  */
	public int getC_OpportunityLine_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_OpportunityLine_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set Line Total Amount.
		@param LineTotalAmount Line Total Amount	  */
	public void setLineTotalAmount (BigDecimal LineTotalAmount)
	{
		set_Value (COLUMNNAME_LineTotalAmount, LineTotalAmount);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_LineTotalAmount);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
