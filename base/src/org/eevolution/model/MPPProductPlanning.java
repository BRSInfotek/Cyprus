...
import org.cyprusbrs.model.MResource;
...
public class MPPProductPlanning extends X_PP_Product_Planning
{
	...
	protected boolean beforeSave(boolean newRecord)
	{
		...
		{
			throw new CyprusException("@Order_Min@ > @Order_Max@");
		}
		//
		// Check Order_Period
		...
		{
			throw new CyprusException("@Order_Period@ <= 0");
		}
		//
		// Check Order_Qty
		...
		{
			throw new CyprusException("@Order_Qty@ <= 0");
		}
		//
		return true;
	}
