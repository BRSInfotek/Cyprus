...
public class EnableNativeSequence extends SvrProcess
{
	...
	protected String doIt()              
	{
		...
		{
			throw new CyprusException("Native Sequence is Actived");
		}
	...
	private void createSequence(MTable table, String trxName)
	{
		...
		{	
			...
			{
				throw new CyprusException("Can not create Native Sequence for table "+table.getTableName());
			}	
			else
			{	
	...
	public static void main(String[] args) 
	{
		...
		if (pi.isError())
		{
			throw new CyprusException(pi.getSummary());
		}
	}
}
