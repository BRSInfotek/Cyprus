...
import org.cyprusbrs.model.I_C_BPartner;
import org.cyprusbrs.model.I_M_Product;
import org.cyprusbrs.model.I_M_Product_Category;
import org.cyprusbrs.model.I_M_Warehouse;
import org.cyprusbrs.model.MBPGroup;
...
import org.cyprusbrs.model.MMovementLine;
...
import org.cyprusbrs.model.MProductCategory;
import org.cyprusbrs.model.MProductPrice;
import org.cyprusbrs.model.MTaxCategory;
...
//		po.saveEx();
		...
		try
		{
			if (!doc.document.processIt(docAction))
				throw new CyprusException(doc.document.getProcessMsg());
		}
		catch (Exception e)
		{
			throw (e instanceof CyprusException ? (CyprusException)e : new CyprusException(e));
		}
		po.saveEx();
		//
		// Check DocSatus
		...
		{
			throw new CyprusException("Doc process error "+doc
