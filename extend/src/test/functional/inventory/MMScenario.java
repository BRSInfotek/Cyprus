...
public class MMScenario
{
	...
	public MMDocument get(String docBaseType, String documentNo)
	{
		...
		throw new CyprusException("["+name+"] document not found for"
	...
	public void registerASICode(String asiCode, int M_ASI_ID, boolean isCreated)
	{
		...
		{
			throw new CyprusException("ASI Should be unique : Code="+asiCode+", ID="+M_ASI_ID);
		}
	...
	public int getM_ASI_ID(String asiCode)
	{
		...
		if (asi_id == null)
		{
			throw new CyprusException("No ASI created for Code="+asiCode);
		}
		return asi_id;
	}
