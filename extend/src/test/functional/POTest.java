...
import org.cyprusbrs.model.MTest;
...
/**
 * Tests for {@link org.cyprusbrs.model.PO} class.
...
public class POTest extends AdempiereTestCase
{
	 ...
	 * <ul> 
	 * <li>{@link org.cyprusbrs.model.PO#is_Changed()}
	 * <li>{@link org.cyprusbrs.model.PO#is_ValueChanged(String)}
	 * </ul> 
	...
	public void testAD_OrgBP_ID_Issue() throws Exception
	{
		...
		// at org.cyprusbrs.model.X_C_BPartner.getAD_OrgBP_ID(X_C_BPartner.java:165)
		// at org.cyprusbrs.model.MBPartner.getAD_OrgBP_ID_Int(MBPartner.java:602)
