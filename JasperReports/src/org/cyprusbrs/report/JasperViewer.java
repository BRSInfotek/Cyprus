...
//        		DriverManager.registerDriver(new net.sourceforge.jtds.jdbc.Driver());
    ...
    public static Connection getConnection() {
        try {
            DriverManager.registerDriver(new oracle.jdbc.driver.OracleDriver());
            //this is for test only prefer testingby calling org.cyprusbrs.report.JaserViewer JDBC_CONNECTION JDBC_USER JDBC_PASS
            return DriverManager.getConnection("jdbc:oracle:thin:@abalone.lesmuids.com:1521:abalone", "cyprus", "cyprus");
        } catch (SQLException e) {
            e.printStackTrace();
            return null;
        }
