...
import org.cyprusbrs.cm.utils.AccessLogger;
import org.cyprusbrs.cm.utils.LocaleHandler;
import org.cyprusbrs.cm.utils.RequestAnalyzer;
import org.cyprusbrs.cm.xml.Generator;
import org.cyprusbrs.cm.xml.XSLTProcessor;
		...
		throws ServletException, IOException
	{
		...
		if (configLoaded && !fatalError)
		{
			...
			if (thisRequest.getProcClassName ()!=null) {
				try {
					org.cyprusbrs.cm.Extend thisProcessor = thisRequest.getProcClass();
					thisProcessor.doIt ();
