 ...
 *****************************************************************************/
package org.cyprusbrs.cm.utils;
...
import org.cyprusbrs.cm.Extend;
...
import org.cyprusbrs.model.MContainer;
import org.cyprusbrs.model.MWebProject;
import org.cyprusbrs.model.MWebProjectDomain;
...
public class RequestAnalyzer
{
		...
		boolean showStage, String servletExtend)
	{
		...
		if (m_request.getParameter ("cn")!=null) {
			...
			if (classChecker("cyprus.cm." + className,servlet.getLogger()))
				m_procClassName = "cyprus.cm." + className;
			if (classChecker("org.cyprusbrs.cm.extend." + className,servlet.getLogger()))
				m_procClassName = "org.cyprusbrs.cm.extend." + className;
		}
	}	//	RequestAnalyzer
	...
	private boolean classChecker(String className, CLogger log) {
		try
		{
			...
			{
				if (superClazz == org.cyprusbrs.cm.Extend.class)
				{
	...
	public org.cyprusbrs.cm.Extend getProcClass()
	{
