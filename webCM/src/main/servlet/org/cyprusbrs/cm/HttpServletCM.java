...
import org.cyprusbrs.cm.cache.Container;
import org.cyprusbrs.cm.cache.ContainerElement;
import org.cyprusbrs.cm.cache.ContainerTree;
import org.cyprusbrs.cm.cache.Domain;
import org.cyprusbrs.cm.cache.MediaServer;
import org.cyprusbrs.cm.cache.Template;
import org.cyprusbrs.cm.cache.WebProject;
import org.cyprusbrs.cm.cache.XML;
...
public class HttpServletCM extends HttpServlet
{
		...
		throws ServletException
	{
		...
		org.cyprusbrs.cm.utils.CMEnv cmEnv = new org.cyprusbrs.cm.utils.CMEnv ();
     ...
     */
	public org.cyprusbrs.cm.cache.Container getContainerCache ()
	{
     ...
     */
	public org.cyprusbrs.cm.cache.Chat getChatCache ()
	{
		return chatCache;
	}
     ...
     */
	public org.cyprusbrs.cm.cache.ContainerElement getContainerElementCache ()
	{
     ...
     * @return CO Object ContainerElement
     */
	public org.cyprusbrs.cm.cache.ContainerTree getContainerTreeCache ()
	{
     ...
     */
	public org.cyprusbrs.cm.cache.Domain getDomainCache ()
	{
		return domainCache;
	}
     ...
     */
	public org.cyprusbrs.cm.cache.MediaServer getMediaServerCache ()
	{
     ...
     */
	public org.cyprusbrs.cm.cache.WebProject getWebProjectCache ()
	{
     ...
     */
	public org.cyprusbrs.cm.cache.Template getTemplateCache ()
	{
     ...
     * @return CO Object Template
     */
	public org.cyprusbrs.cm.cache.XML getXMLCache ()
	{
		return xmlCache;
	}
