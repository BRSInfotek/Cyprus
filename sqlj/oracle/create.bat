...
@SET CLASSPATH=
@call loadjava -user %1@%CYPRUS_DB_SERVER%/%CYPRUS_DB_NAME% -verbose -force -resolve %CYPRUS_HOME%\lib\sqlj.jar

@Echo .

@Echo Create Oracle Functions ...
@sqlplus %1@%CYPRUS_DB_SERVER%/%CYPRUS_DB_NAME% @%CYPRUS_HOME%\utils\oracle\createSQLJ.sql
