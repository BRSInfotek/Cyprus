...
public class Currency
{
		...
		throws SQLException
	{
		...
		int C_CurrencyTo_ID = Cyprus.getSQLValue(sql, p_AD_Client_ID);
		//	Return Amount
		...
		throws SQLException
	{
		...
		ConversionDate = Cyprus.trunc(ConversionDate);
		//
		...
		if (C_ConversionType_ID == 0)
		{
			...
			C_ConversionType_ID = Cyprus.getSQLValue(sql, p_AD_Client_ID);
		}
