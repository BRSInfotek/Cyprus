...
/**
 * 	Cyprus Monitor Filter.
 * 	Application Server independent check of username/password
 * 	
 *  @author Jorg Janke
 *  @version $Id: CyprusMonitorFilter.java,v 1.2 2006/07/30 00:53:33 jjanke Exp $
 *  @author Michael Judd BF [ 2736817 ] - remove deprecated BASE64Encoder classes
 */
public class CyprusMonitorFilter implements Filter
{
	/**
	 * 	CyprusMonitorFilter
	 */
	public CyprusMonitorFilter ()
	{
		super ();
	...
	/**	Authorization ID				*/
	private static final String		AUTHORIZATION = "CyprusAuthorization";
		...
		throws IOException, ServletException
	{
		...
		try
		{
			...
			else
			{
				...
				resp.setHeader("WWW-Authenticate", "BASIC realm=\"Cyprus Server\"");
			}
			return;
		}
		catch (Exception e)
