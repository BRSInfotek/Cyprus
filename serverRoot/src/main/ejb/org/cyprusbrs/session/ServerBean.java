...
import org.cyprus.util.ProcessUtil;
import org.cyprusbrs.Cyprus;
import org.cyprusbrs.acct.Doc;
import org.cyprusbrs.interfaces.Server;
import org.cyprusbrs.interfaces.ServerLocal;
import org.cyprusbrs.interfaces.ServerRemote;
...
public class ServerBean implements ServerRemote, ServerLocal
{
	...
	public void ejbCreate() 
	{
		...
		try
		{
			if (!Cyprus.startup(false))
				throw new CreateException("Cyprus could not start");
		}
		catch (Exception ex)
		{
