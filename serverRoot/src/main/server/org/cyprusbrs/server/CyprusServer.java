...
import org.cyprusbrs.ldap.LdapProcessor;
import org.cyprusbrs.model.CyprusProcessor;
import org.cyprusbrs.model.CyprusProcessor2;
 ...
 */
public abstract class CyprusServer extends Thread
{
	/**
	 ...
	 */
	public static CyprusServer create (CyprusProcessor model)
	{
	 ...
	 */
	protected CyprusServer (CyprusProcessor model, int initialNap)
	{
		super (CyprusServerGroup.get(), null, model.getName(), 0);
		p_model = model;
	...
	/**	The Processor Model						*/
	protected					CyprusProcessor 	p_model;
	...
	public void run ()
	{
		...
		while (true)
		{
			...
			if (p_model instanceof CyprusProcessor2)
			{
				CyprusProcessor2 ap = (CyprusProcessor2) p_model;
	 ...
	 *	@return Model
	 */
	public CyprusProcessor getModel()
	{
		return p_model;
	}	//	getModel
	 ...
	 *	@return logs
	 */
	public CyprusProcessorLog[] getLogs()
	{
